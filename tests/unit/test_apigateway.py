...
from shipyard.aws.api.apigateway import Model
...
from shipyard.services.apigateway.integration import (
    LambdaProxyIntegration,
    apply_request_parameters,
)
from shipyard.services.apigateway.invocations import ApiInvocationContext, RequestValidator
...
from shipyard.utils.aws.aws_responses import requests_response
from shipyard.utils.common import clone
...
class TestApigatewayEvents:
    def test_construct_invocation_event(self):
        tt = [
            {
                "method": "GET",
                "path": "http://localhost.shipyard.khulnasoft.com",
                "headers": {},
                "data": None,
            ...
            {
                "method": "GET",
                "path": "http://localhost.shipyard.khulnasoft.com?baz=qux",
                "headers": {},
                "data": None,
                "query_string_params": {"foo": "bar"},
                "is_base64_encoded": False,
