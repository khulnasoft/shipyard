...
from shipyard.aws.protocol.parser import (
...
from shipyard.http import Request as HttpRequest
...
def test_sqs_query_parse_tag_map_with_member_name_as_location():
    # see https://github.com/khulnasoft/shipyard/issues/4391
    ...
    # https://github.com/khulnasoft/shipyard/issues/4391
    request = HttpRequest(
        "POST",
        "/",
        body="Action=TagQueue&"
