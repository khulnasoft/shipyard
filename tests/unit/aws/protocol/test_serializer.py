...
from shipyard.aws.api import CommonServiceException, ServiceException
from shipyard.aws.api.dynamodb import (
    AttributeValue,
    CancellationReason,
    TransactionCanceledException,
)
from shipyard.aws.api.kinesis import GetRecordsOutput, Record
from shipyard.aws.api.lambda_ import ResourceNotFoundException
from shipyard.aws.api.route53 import NoSuchHostedZone
from shipyard.aws.api.sns import VerificationException
from shipyard.aws.api.sqs import (
    InvalidMessageContents,
    ReceiptHandleIsInvalid,
    UnsupportedOperation,
)
from shipyard.aws.api.sts import Credentials, GetSessionTokenResponse
from shipyard.aws.protocol.serializer import (
...
from shipyard.constants import APPLICATION_AMZ_CBOR_1_1
from shipyard.http import Request, Response
from shipyard.utils.common import to_str
...
def test_rest_xml_serializer_route53_with_botocore():
    parameters = {
        ...
        "DelegationSet": {"NameServers": ["dns.localhost.shipyard.khulnasoft.com"]},
    }
...
class TestAwsResponseSerializerDecorator:
    ...
    def test_query_valid_response(self):
        @aws_response_serializer("sqs-query", "ListQueues")
        def fn(request: Request):
            from shipyard.aws.api.sqs import ListQueuesResult
