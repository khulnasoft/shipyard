...
from shipyard.aws.forwarder import create_aws_request_context
from shipyard.aws.handlers.service import ServiceExceptionSerializer, ServiceResponseParser
...
class TestServiceResponseHandler:
    ...
    def test_service_exception(self, service_response_handler_chain):
        from shipyard.aws.api.opensearch import ResourceAlreadyExistsException
    ...
    def test_service_exception_with_code_from_spec(self, service_response_handler_chain):
        from shipyard.aws.api.sqs import QueueDoesNotExist
    ...
    def test_nothing_set_does_nothing(self, service_response_handler_chain):
        ...
        context.request = Request("GET", "/_shipyard/health")
