...
from shipyard.http.request import Request, dummy_wsgi_environment, get_raw_path
...
def test_validate_dummy_environment():
    ...
    validate(server=("shipyard.khulnasoft.com", 4566))
    validate(server=("shipyard.khulnasoft.com", None))
