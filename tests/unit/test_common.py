...
from shipyard.utils.objects import Mock
from shipyard.utils.strings import base64_decode, to_bytes
from shipyard.utils.testutil import create_zip_file
...
class TestCommon:
    ...
    def test_fully_qualified_class_name(self):
        assert fully_qualified_class_name(Mock) == "shipyard.utils.objects.Mock"
