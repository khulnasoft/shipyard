...
from shipyard.aws.api.sns import InvalidParameterException
from shipyard.services.sns.models import SnsMessage
from shipyard.services.sns.provider import (
    encode_subscription_token_with_region,
    get_region_from_subscription_token,
    is_raw_message_delivery,
)
from shipyard.services.sns.publisher import SubscriptionFilter, create_sns_message_body
...
class TestSns:
    ...
    def test_create_sns_message_body(self, subscriber):
        ...
        expected_sns_body = {
            ...
            "TopicArn": "arn",
            "Type": "Notification",
            "UnsubscribeURL": f"http://localhost.shipyard.khulnasoft.com:4566/?Action=Unsubscribe&SubscriptionArn={subscriber['SubscriptionArn']}",
        }
