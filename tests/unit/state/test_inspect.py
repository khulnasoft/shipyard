...
from shipyard.services.sqs import models as sqs_models
from shipyard.state.inspect import ReflectionStateLocator, ServiceBackendCollectorVisitor
...
class TestReflectionStateLocator:
    def test_collect_store(self, sample_stores, monkeypatch):
        ...
        store_backend = backends.get("shipyard")
