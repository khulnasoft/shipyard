...
import (
	...
	"github.com/khulnasoft/shipyard/models/packages"
	conan_model "github.com/khulnasoft/shipyard/models/packages/conan"
	"github.com/khulnasoft/shipyard/models/unittest"
	user_model "github.com/khulnasoft/shipyard/models/user"
	conan_module "github.com/khulnasoft/shipyard/modules/packages/conan"
	"github.com/khulnasoft/shipyard/modules/setting"
	conan_router "github.com/khulnasoft/shipyard/routers/api/packages/conan"
...
const (
	...
	conanLicense     = "MIT"
	conanAuthor      = "Shipyard <info@shipyard.io>"
	conanHomepage    = "https://shipyard.io/"
	conanURL         = "https://shipyard.khulnasoft.com/"
		...
		t.Run("Search", func(t *testing.T) {
			...
			t.Run("Recipe", func(t *testing.T) {
				...
				cases := []struct {
					...
					{"ConanPackage", []string{"ConanPackage/1.2@dummy/test", "ConanPackage/1.3@dummy/test", "ConanPackage/1.2@dummy/final", "ConanPackage/1.2@shipyard/test", "ConanPackage/1.2@shipyard/final"}},
					{"ConanPackage/1.2", []string{"ConanPackage/1.2@dummy/test", "ConanPackage/1.2@dummy/final", "ConanPackage/1.2@shipyard/test", "ConanPackage/1.2@shipyard/final"}},
					{"ConanPackage/1.1", []string{}},
					{"Conan*", []string{"ConanPackage/1.2@dummy/test", "ConanPackage/1.3@dummy/test", "ConanPackage/1.2@dummy/final", "ConanPackage/1.2@shipyard/test", "ConanPackage/1.2@shipyard/final"}},
					{"ConanPackage/", []string{"ConanPackage/1.2@dummy/test", "ConanPackage/1.3@dummy/test", "ConanPackage/1.2@dummy/final", "ConanPackage/1.2@shipyard/test", "ConanPackage/1.2@shipyard/final"}},
					{"ConanPackage/*", []string{"ConanPackage/1.2@dummy/test", "ConanPackage/1.3@dummy/test", "ConanPackage/1.2@dummy/final", "ConanPackage/1.2@shipyard/test", "ConanPackage/1.2@shipyard/final"}},
					{"ConanPackage/1*", []string{"ConanPackage/1.2@dummy/test", "ConanPackage/1.3@dummy/test", "ConanPackage/1.2@dummy/final", "ConanPackage/1.2@shipyard/test", "ConanPackage/1.2@shipyard/final"}},
					{"ConanPackage/*2", []string{"ConanPackage/1.2@dummy/test", "ConanPackage/1.2@dummy/final", "ConanPackage/1.2@shipyard/test", "ConanPackage/1.2@shipyard/final"}},
					{"ConanPackage/1*2", []string{"ConanPackage/1.2@dummy/test", "ConanPackage/1.2@dummy/final", "ConanPackage/1.2@shipyard/test", "ConanPackage/1.2@shipyard/final"}},
					{"ConanPackage/1.2@", []string{"ConanPackage/1.2@dummy/test", "ConanPackage/1.2@dummy/final", "ConanPackage/1.2@shipyard/test", "ConanPackage/1.2@shipyard/final"}},
					...
					{"ConanPackage/1.2@shipyard/*", []string{"ConanPackage/1.2@shipyard/test", "ConanPackage/1.2@shipyard/final"}},
					{"*/*@dummy", []string{"ConanPackage/1.2@dummy/test", "ConanPackage/1.3@dummy/test", "ConanPackage/1.2@dummy/final"}},
					{"*/*@*/final", []string{"ConanPackage/1.2@dummy/final", "ConanPackage/1.2@shipyard/final"}},
				}
		...
		t.Run("Search", func(t *testing.T) {
			t.Run("Recipe", func(t *testing.T) {
				...
				cases := []struct {
					...
					{"ConanPackage", []string{"ConanPackage/1.2@dummy/test", "ConanPackage/1.3@dummy/test", "ConanPackage/1.2@shipyard/test", "ConanPackage/1.2@shipyard/final"}},
					{"ConanPackage/1.2", []string{"ConanPackage/1.2@dummy/test", "ConanPackage/1.2@shipyard/test", "ConanPackage/1.2@shipyard/final"}},
					{"ConanPackage/1.1", []string{}},
					{"Conan*", []string{"ConanPackage/1.2@dummy/test", "ConanPackage/1.3@dummy/test", "ConanPackage/1.2@shipyard/test", "ConanPackage/1.2@shipyard/final"}},
					{"ConanPackage/", []string{"ConanPackage/1.2@dummy/test", "ConanPackage/1.3@dummy/test", "ConanPackage/1.2@shipyard/test", "ConanPackage/1.2@shipyard/final"}},
					{"ConanPackage/*", []string{"ConanPackage/1.2@dummy/test", "ConanPackage/1.3@dummy/test", "ConanPackage/1.2@shipyard/test", "ConanPackage/1.2@shipyard/final"}},
					{"ConanPackage/1*", []string{"ConanPackage/1.2@dummy/test", "ConanPackage/1.3@dummy/test", "ConanPackage/1.2@shipyard/test", "ConanPackage/1.2@shipyard/final"}},
					{"ConanPackage/*2", []string{"ConanPackage/1.2@dummy/test", "ConanPackage/1.2@shipyard/test", "ConanPackage/1.2@shipyard/final"}},
					{"ConanPackage/1*2", []string{"ConanPackage/1.2@dummy/test", "ConanPackage/1.2@shipyard/test", "ConanPackage/1.2@shipyard/final"}},
					{"ConanPackage/1.2@", []string{"ConanPackage/1.2@dummy/test", "ConanPackage/1.2@shipyard/test", "ConanPackage/1.2@shipyard/final"}},
					...
					{"*/*@*/final", []string{"ConanPackage/1.2@shipyard/final"}},
				}
