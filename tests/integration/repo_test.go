...
func TestViewRepoDirectoryReadme(t *testing.T) {
	...
	// - READMEs can be stored in docs/, .shipyard/, or .github/
	...
	check(".shipyard", "/user2/readme-test/src/branch/special-subdir-.shipyard/", ".shipyard/README.md", "markdown", "This is in .shipyard/")
	...
	//    .shipyard/README.zh-cn.md, .shipyard/README.zh_cn.md, .shipyard/README.zh.md, .shipyard/README_zh.md, .shipyard/README.md, .shipyard/README.txt, .shipyard/README,
	...
	check("fallback/7", "/user2/readme-test/src/branch/fallbacks7/", ".shipyard/README.en.md", "markdown", "This is .shipyard/README.en.md")
	check("fallback/8", "/user2/readme-test/src/branch/fallbacks8/", ".shipyard/README.md", "markdown", "This is .shipyard/README.md")
	check("fallback/9", "/user2/readme-test/src/branch/fallbacks9/", ".shipyard/README", "plain-text", "This is .shipyard/README")
