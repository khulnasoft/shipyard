...
import (
	...
	swift_module "github.com/khulnasoft/shipyard/modules/packages/swift"
	"github.com/khulnasoft/shipyard/modules/setting"
	swift_router "github.com/khulnasoft/shipyard/routers/api/packages/swift"
...
func TestPackageSwift(t *testing.T) {
	...
	packageRepositoryURL := "https://shipyard.io/shipyard/shipyard"
