...
func TestAPIRepoMigrate(t *testing.T) {
	testCases := []struct {
		...
		{ctxUserID: 1, userID: 2, cloneURL: "https://github.com/go-shipyard/test_repo.git", repoName: "git-admin", expectedStatus: http.StatusCreated},
		{ctxUserID: 2, userID: 2, cloneURL: "https://github.com/go-shipyard/test_repo.git", repoName: "git-own", expectedStatus: http.StatusCreated},
		{ctxUserID: 2, userID: 1, cloneURL: "https://github.com/go-shipyard/test_repo.git", repoName: "git-bad", expectedStatus: http.StatusForbidden},
		{ctxUserID: 2, userID: 3, cloneURL: "https://github.com/go-shipyard/test_repo.git", repoName: "git-org", expectedStatus: http.StatusCreated},
		{ctxUserID: 2, userID: 6, cloneURL: "https://github.com/go-shipyard/test_repo.git", repoName: "git-bad-org", expectedStatus: http.StatusForbidden},
...
func TestAPIRepoMigrateConflict(t *testing.T) {
	onShipyardRun(t, testAPIRepoMigrateConflict)
}
...
func testAPIRepoMigrateConflict(t *testing.T, u *url.URL) {
	...
	t.Run("Existing", func(t *testing.T) {
		...
		cloneURL := "https://github.com/go-shipyard/test_repo.git"
...
func TestAPIRepoCreateConflict(t *testing.T) {
	onShipyardRun(t, testAPIRepoCreateConflict)
}
