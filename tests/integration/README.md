...
Start tests based on the database container
```
TEST_MSSQL_HOST=localhost:1433 TEST_MSSQL_DBNAME=shipyard_test TEST_MSSQL_USERNAME=sa TEST_MSSQL_PASSWORD=MwantsaSecurePassword1 make test-mssql
```
...
```bash
SHIPYARD_SLOW_TEST_TIME="10s" SHIPYARD_SLOW_FLUSH_TIME="5s" make test-sqlite
```
