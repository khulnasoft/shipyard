						...
						for {
							...
							for {
								...
								if hd.Name == "APKINDEX" {
									...
									assert.Contains(t, s, "T:Shipyard Test Package\n")
									assert.Contains(t, s, "U:https://shipyard.io/\n")
									assert.Contains(t, s, "L:MIT\n")
									assert.Contains(t, s, "S:1353\n")
									assert.Contains(t, s, "I:4096\n")
									assert.Contains(t, s, "o:shipyard-test\n")
									assert.Contains(t, s, "m:KN4CK3R <kn4ck3r@shipyard.io>\n")
