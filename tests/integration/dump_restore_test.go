...
func TestDumpRestore(t *testing.T) {
	onShipyardRun(t, func(t *testing.T, u *url.URL) {
		...
		// Shipyard SDK (go-sdk) need to parse the AppVer from server response, so we must set it to a valid version string.
		...
		//
		// Phase 1: dump repo1 from the Shipyard instance to the filesystem
		//
		...
		//
		// Phase 2: restore from the filesystem to the Shipyard instance in restoredrepo
		//
		...
		//
		// Phase 3: dump restored from the Shipyard instance to the filesystem
		//
