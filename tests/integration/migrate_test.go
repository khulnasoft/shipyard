...
func TestMigrateShipyardForm(t *testing.T) {
	onShipyardRun(t, func(t *testing.T, u *url.URL) {
		...
		// Step 1: get the Shipyard migration form
		req = NewRequestf(t, "GET", "/repo/migrate/?service_type=%d", structs.ShipyardService)
		...
		req = NewRequestWithValues(t, "POST", link, map[string]string{
			...
			"service":     fmt.Sprintf("%d", structs.ShipyardService),
