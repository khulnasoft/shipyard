...
import (
	...
	nuget_module "github.com/khulnasoft/shipyard/modules/packages/nuget"
...
func TestPackageNuGet(t *testing.T) {
	...
	packageDescription := "Shipyard Test Package"
...
AAAjQmxvYgAAAGm7ENm9SGxMtAFVvPUsPJTF6PbtAAAAAFcVogEJAAAAAQAAAA==`)
	...
	t.Run("Download", func(t *testing.T) {
		...
		t.Run("Symbol", func(t *testing.T) {
			...
			req := NewRequest(t, "GET", fmt.Sprintf("%s/symbols/%s/%sFFFFFFFF/shipyard.pdb", url, symbolFilename, symbolID))
			MakeRequest(t, req, http.StatusBadRequest)
