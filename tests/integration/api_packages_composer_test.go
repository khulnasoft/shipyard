...
import (
	...
	composer_module "github.com/khulnasoft/shipyard/modules/packages/composer"
...
func TestPackageComposer(t *testing.T) {
	...
	packageAuthor := "Shipyard Authors"
	packageLicense := "MIT"
	...
	t.Run("SearchService", func(t *testing.T) {
		...
		cases := []struct {
			...
			{"shipyard", "", 2, 1, 1, 0},
			{"", packageType, 1, 1, 1, 1},
			{"shipyard", packageType, 1, 1, 1, 1},
			{"shipyard", "dummy", 1, 1, 0, 0},
		}
