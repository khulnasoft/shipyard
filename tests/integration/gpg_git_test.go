...
func TestGPGGit(t *testing.T) {
	...
	rootKeyPair, err := importTestingKey(tmpDir, "shipyard", "shipyard@fake.local")
	...
	defer test.MockVariableValue(&setting.Repository.Signing.SigningName, "shipyard")()
	defer test.MockVariableValue(&setting.Repository.Signing.SigningEmail, "shipyard@fake.local")()
	...
	onShipyardRun(t, func(t *testing.T, u *url.URL) {
		...
		t.Run("Unsigned-Initial-CRUD-Always", func(t *testing.T) {
			...
			t.Run("CreateCRUDFile-Always", crudActionCreateFile(
				t, testCtx, user, "master", "always", "signed-always.txt", func(t *testing.T, response api.FileResponse) {
					...
					assert.Equal(t, "shipyard@fake.local", response.Verification.Signer.Email)
				}))
		...
		t.Run("AlwaysSign-Initial", func(t *testing.T) {
			...
			t.Run("CheckMasterBranchSigned", doAPIGetBranch(testCtx, "master", func(t *testing.T, branch api.Branch) {
				...
				assert.Equal(t, "shipyard@fake.local", branch.Commit.Verification.Signer.Email)
			}))
		})
