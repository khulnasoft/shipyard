...
import (
	...
	cargo_module "github.com/khulnasoft/shipyard/modules/packages/cargo"
	"github.com/khulnasoft/shipyard/modules/setting"
	cargo_router "github.com/khulnasoft/shipyard/routers/api/packages/cargo"
	cargo_service "github.com/khulnasoft/shipyard/services/packages/cargo"
...
func TestPackageCargo(t *testing.T) {
	onShipyardRun(t, testPackageCargo)
}
...
func testPackageCargo(t *testing.T, _ *neturl.URL) {
	...
	packageHomepage := "https://shipyard.io/"
	packageLicense := "MIT"
   ...
   "deps":[
      {
         "name":"dep",
         "version_req":"1.0",
         "registry": "https://shipyard.io/user/_cargo-index",
         "kind": "normal",
			...
			t.Run("Index", func(t *testing.T) {
				t.Run("Git", func(t *testing.T) {
					t.Run("Entry", func(t *testing.T) {
						...
						assert.Equal(t, "https://shipyard.io/user/_cargo-index", *dep.Registry)
