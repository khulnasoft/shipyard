...
index = "lambda-index"
type = "lambda-type"
if os.getenv("SHIPYARD_HOSTNAME"):
    url = "http://" + os.environ["ESENDPOINT"] + "/_search"  # TODO ssl error for shipyard
    url = url.replace("localhost.shipyard.khulnasoft.com", os.getenv("SHIPYARD_HOSTNAME"))
else:
    url = (
