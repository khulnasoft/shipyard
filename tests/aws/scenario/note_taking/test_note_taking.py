...
which was adapted to work with Shipyard https://github.com/khulnasoft-samples/sample-notes-app-dynamodb-lambda-apigateway.
"""
import copy
import json
import logging
...
from shipyard.testing.scenario.cdk_lambda_helper import load_nodejs_lambda_to_s3
