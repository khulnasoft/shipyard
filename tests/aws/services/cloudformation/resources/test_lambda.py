...
from shipyard.aws.api.lambda_ import InvocationType, Runtime, State
...
from shipyard.utils.testutil import create_lambda_archive, get_lambda_log_events
...
class TestCfnLambdaIntegrations:
    ...
    @markers.snapshot.skip_snapshot_verify(
        paths=[
            ...
            "$..StackResources..PhysicalResourceId",  # TODO: compatibility between AWS URL and shipyard URL
        ]
    )
    @markers.aws.validated
