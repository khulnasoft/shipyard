...
from shipyard.aws.api.dynamodb import PointInTimeRecoverySpecification
from shipyard.constants import AWS_REGION_US_EAST_1, TEST_AWS_ACCOUNT_ID, TEST_AWS_REGION_NAME
from shipyard.services.dynamodbstreams.dynamodbstreams_api import get_kinesis_stream_name
from shipyard.testing.aws.lambda_utils import _await_dynamodb_table_active
...
from shipyard.utils.aws import arns, queries, resources
from shipyard.utils.aws.resources import create_dynamodb_table
from shipyard.utils.common import json_safe, long_uid, retry, short_uid
from shipyard.utils.sync import poll_condition, wait_until
...
class TestDynamoDB:
    ...
    @markers.aws.only_shipyard(reason="AWS has a 20 GSI limit")
    ...
    def test_nosql_workbench_localhost_region(self, dynamodb_create_table, aws_client_factory):
        ...
        Shipyard must assume "us-east-1" region in such cases.
        """
