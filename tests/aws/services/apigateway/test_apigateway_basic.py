...
from shipyard.utils.aws import resources as resource_util
from shipyard.utils.aws.request_context import mock_aws_request_headers
from shipyard.utils.collections import select_attributes
...
class TestAPIGateway:
    ...
    def _get_invoke_endpoint(
        ...
        if use_hostname:
            host = f"{api_id}.execute-api.{shipyard_host().host}"
