...
@markers.snapshot.skip_snapshot_verify(
    paths=[
        ...
        "$..headers.accept",
        "$..headers.accept-encoding",
        "$..headers.x-shipyard-edge",
        "$..headers.x-shipyard-request-url",
        "$..headers.x-shipyard-tgt-api",
        ...
        "$..multiValueHeaders.accept",
        "$..multiValueHeaders.accept-encoding",
        "$..multiValueHeaders.x-shipyard-edge",
        "$..multiValueHeaders.x-shipyard-request-url",
        "$..multiValueHeaders.x-shipyard-tgt-api",
        "$..pathParameters",
...
def test_lambda_aws_integration_with_request_template(
    ...
    # additional checks from https://github.com/khulnasoft/shipyard/issues/5041
