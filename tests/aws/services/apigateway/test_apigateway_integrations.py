...
from shipyard.constants import APPLICATION_JSON, TEST_AWS_ACCOUNT_ID
from shipyard.services.apigateway.helpers import path_based_url
from shipyard.services.lambda_.networking import get_main_endpoint_from_container
from shipyard.testing.aws.util import is_aws_cloud
from shipyard.testing.pytest import markers
from shipyard.testing.pytest.fixtures import PUBLIC_HTTP_ECHO_SERVER_URL
