...
from shipyard.aws.api.lambda_ import InvalidParameterValueException, Runtime
...
class TestDynamoDBEventSourceMapping:
    ...
    def test_dynamodb_event_filter(
        ...
        if item_to_put2:
            ...
            # putting the same item (item_to_put1) a second time is a 'MODIFY' request (at least in Shipyard)
            aws_client.dynamodb.put_item(TableName=table_name, Item=item_to_put1)
