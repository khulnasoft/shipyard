...
from shipyard.constants import APPLICATION_JSON, TEST_AWS_ACCESS_KEY_ID, TEST_AWS_REGION_NAME
from shipyard.testing.aws.util import create_client_with_keys
