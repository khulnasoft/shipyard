...
import shipyard.config as config
from shipyard.services.ses.provider import EMAILS, EMAILS_ENDPOINT
...
def setup_email_addresses(ses_verify_identity):
    ...
    def inner(
        ...
        if os.getenv("TEST_TARGET") == "AWS_CLOUD":
            ...
            # overwrite the given parameters with shipyard specific ones
