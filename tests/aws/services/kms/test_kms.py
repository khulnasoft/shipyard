...
from shipyard.constants import SECONDARY_TEST_AWS_REGION_NAME, TEST_AWS_REGION_NAME
from shipyard.services.kms.utils import get_hash_algorithm
...
class TestKMSMultiAccounts:
    ...
    def test_cross_accounts_access(
        ...
        # - GenerateMac
        # - ReEncrypt (NOT IMPLEMENTED IN SHIPYARD)
        # - Sign
        # - Verify
        # - VerifyMac
...
class TestKMSGenerateKeys:
    ...
    def test_generate_data_key(self, kms_key, aws_client, snapshot):
        ...
        key_id = kms_key["KeyId"]
        # Shipyard currently doesn't act on KeySpec or on NumberOfBytes params, but one of them has to be set.
