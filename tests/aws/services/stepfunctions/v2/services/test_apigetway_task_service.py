...
from shipyard.testing.snapshots.transformer import JsonpathTransformer
...
@markers.snapshot.skip_snapshot_verify(
    paths=[
        ...
        #  shipyard.services.stepfunctions.asl.component.state.state_execution.state_task.service.state_task_service_api_gateway.StateTaskServiceApiGateway._invoke_output_of
