...
from shipyard.constants import TEST_AWS_ACCOUNT_ID, TEST_AWS_REGION_NAME
from shipyard.services.events.provider import _get_events_tmp_dir
from shipyard.testing.aws.eventbus_utils import allow_event_rule_to_sqs_queue
from shipyard.testing.aws.util import is_aws_cloud
from shipyard.testing.pytest import markers
from shipyard.utils.aws import arns, resources
...
class TestEvents:
    ...
    def test_should_ignore_schedules_for_put_event(
        ...
        """Regression test for https://github.com/khulnasoft/shipyard/issues/7847"""
