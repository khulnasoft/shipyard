...
import (
	...
	"github.com/khulnasoft/shipyard/modules/auth/openid"
...
type User struct {
	...
	// the user is a Shipyard admin, who can access all repositories and the admin pages.
	IsAdmin bool
	// true: the user is only allowed to see organizations/repositories that they has explicit rights to.
	// (ex: in private Shipyard instances user won't be allowed to see even organizations/repositories that are set as public)
