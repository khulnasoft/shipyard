...
func TestRepoAPIURL(t *testing.T) {
	...
	assert.Equal(t, "https://try.shipyard.io/api/v1/repos/user12/repo10", repo.APIURL())
}
...
func TestGetRepositoryByURL(t *testing.T) {
	...
	t.Run("ValidHttpURL", func(t *testing.T) {
		...
		test(t, "https://try.shipyard.io/user2/repo2")
		test(t, "https://try.shipyard.io/user2/repo2.git")
	})
	...
	t.Run("ValidGitSshURL", func(t *testing.T) {
		...
		test(t, "git+ssh://sshuser@try.shipyard.io/user2/repo2")
		test(t, "git+ssh://sshuser@try.shipyard.io/user2/repo2.git")

		test(t, "git+ssh://try.shipyard.io/user2/repo2")
		test(t, "git+ssh://try.shipyard.io/user2/repo2.git")
	})
	...
	t.Run("ValidImplicitSshURL", func(t *testing.T) {
		...
		test(t, "sshuser@try.shipyard.io:user2/repo2")
		test(t, "sshuser@try.shipyard.io:user2/repo2.git")

		test(t, "try.shipyard.io:user2/repo2")
		test(t, "try.shipyard.io:user2/repo2.git")
	})
}
