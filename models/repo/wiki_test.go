...
func TestRepository_WikiCloneLink(t *testing.T) {
	...
	assert.Equal(t, "ssh://sshuser@try.shipyard.io:3000/user2/repo1.wiki.git", cloneLink.SSH)
	assert.Equal(t, "https://try.shipyard.io/user2/repo1.wiki.git", cloneLink.HTTPS)
}
