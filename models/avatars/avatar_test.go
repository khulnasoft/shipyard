...
import (
	...
	avatars_model "github.com/khulnasoft/shipyard/models/avatars"
...
func TestHashEmail(t *testing.T) {
	...
	assert.Equal(t,
		...
		avatars_model.HashEmail("shipyard@example.com"),
	)
}
...
func TestSizedAvatarLink(t *testing.T) {
	...
	assert.Equal(t, "/testsuburl/assets/img/avatar_default.png",
		avatars_model.GenerateEmailAvatarFastLink(db.DefaultContext, "shipyard@example.com", 100))
