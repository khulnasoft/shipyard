...
func (pt Type) SVGName() string {
	switch pt {
	case TypeAlpine:
		return "shipyard-alpine"
	case TypeCargo:
		return "shipyard-cargo"
	case TypeChef:
		return "shipyard-chef"
	case TypeComposer:
		return "shipyard.khulnasoft.composer"
	case TypeConan:
		return "shipyard-conan"
	case TypeConda:
		return "shipyard-conda"
	case TypeContainer:
		return "octicon-container"
	case TypeCran:
		return "shipyard-cran"
	case TypeDebian:
		return "shipyard-debian"
	case TypeGeneric:
		return "octicon-package"
	case TypeGo:
		return "shipyard-go"
	case TypeHelm:
		return "shipyard-helm"
	case TypeMaven:
		return "shipyard-maven"
	case TypeNpm:
		return "shipyard-npm"
	case TypeNuGet:
		return "shipyard-nuget"
	case TypePub:
		return "shipyard-pub"
	case TypePyPI:
		return "shipyard-python"
	case TypeRpm:
		return "shipyard-rpm"
	case TypeRubyGems:
		return "shipyard-rubygems"
	case TypeSwift:
		return "shipyard-swift"
	case TypeVagrant:
		return "shipyard-vagrant"
	}
	panic(fmt.Sprintf("unknown package type: %s", string(pt)))
}
