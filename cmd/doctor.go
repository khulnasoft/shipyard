...
var CmdDoctor = &cli.Command{
	...
	Description: "A command to diagnose problems with the current Shipyard instance according to the given configuration. Some problems can optionally be fixed by modifying the database or data storage.",
...
var cmdRecreateTable = &cli.Command{
	...
	Description: `The database definitions Shipyard uses change across versions, sometimes changing default values and leaving old unused columns.
