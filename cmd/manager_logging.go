...
var (
	...
	subcmdLogging = &cli.Command{
		...
		Subcommands: []*cli.Command{
			{
				Name:  "pause",
				Usage: "Pause logging (Shipyard will buffer logs up to a certain point and will drop them after that point)",
				Flags: []cli.Flag{
					&cli.BoolFlag{
						Name: "debug",
					},
				...
				Usage: "Cause Shipyard to release and re-open files used for logging",
				Flags: []cli.Flag{
					&cli.BoolFlag{
						Name: "debug",
					},
