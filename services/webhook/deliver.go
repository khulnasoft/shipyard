...
func Deliver(ctx context.Context, t *webhook_model.HookTask) error {
	...
	req.Header.Add("X-Shipyard-Delivery", t.UUID)
	req.Header.Add("X-Shipyard-Event", event)
	req.Header.Add("X-Shipyard-Event-Type", eventType)
	req.Header.Add("X-Shipyard-Signature", signatureSHA256)
