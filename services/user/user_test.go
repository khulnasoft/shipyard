...
func TestCreateUser_Issue5882(t *testing.T) {
	...
	tt := []struct {
		...
		{&user_model.User{Name: "ShipyardBot", Email: "ShipyardBot@shipyard.io", Passwd: passwd, MustChangePassword: false}, false},
		{&user_model.User{Name: "ShipyardBot2", Email: "ShipyardBot2@shipyard.io", Passwd: passwd, MustChangePassword: false}, true},
	}
