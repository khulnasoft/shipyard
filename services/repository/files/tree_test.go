...
func TestGetTreeBySHA(t *testing.T) {
	...
	expectedTree := &api.GitTreeResponse{
		...
		URL: "https://try.shipyard.io/api/v1/repos/user2/repo1/git/trees/65f1bf27bc3bf70f64657658635e66094edbcb4d",
		Entries: []api.GitEntry{
			{
				...
				URL:  "https://try.shipyard.io/api/v1/repos/user2/repo1/git/blobs/4b4851ad51df6a7d9f25c979345979eaeb5b349f",
			},
		},
		Truncated:  false,
		Page:       1,
