...
func getExpectedReadmeContentsResponse() *api.ContentsResponse {
	...
	selfURL := "https://try.shipyard.io/api/v1/repos/user2/repo1/contents/" + treePath + "?ref=master"
	htmlURL := "https://try.shipyard.io/user2/repo1/src/branch/master/" + treePath
	gitURL := "https://try.shipyard.io/api/v1/repos/user2/repo1/git/blobs/" + sha
	downloadURL := "https://try.shipyard.io/user2/repo1/raw/branch/master/" + treePath
...
func TestGetBlobBySHA(t *testing.T) {
	...
	expectedGBR := &api.GitBlobResponse{
		...
		Encoding: "base64",
		URL:      "https://try.shipyard.io/api/v1/repos/user2/repo1/git/blobs/65f1bf27bc3bf70f64657658635e66094edbcb4d",
		SHA:      "65f1bf27bc3bf70f64657658635e66094edbcb4d",
		Size:     180,
	}
	assert.NoError(t, err)
