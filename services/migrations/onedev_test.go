...
func TestOneDevDownloadRepo(t *testing.T) {
	resp, err := http.Get("https://code.onedev.io/projects/go-shipyard-test_repo")
	if err != nil || resp.StatusCode != http.StatusOK {
		t.Skipf("Can't access test repo, skipping %s", t.Name())
	}

	u, _ := url.Parse("https://code.onedev.io")
	downloader := NewOneDevDownloader(context.Background(), u, "", "", "go-shipyard-test_repo")
	if err != nil {
	...
	assertRepositoryEqual(t, &base.Repository{
		Name:        "go-shipyard-test_repo",
		Owner:       "",
		Description: "Test repository for testing migration from OneDev to shipyard",
		CloneURL:    "https://code.onedev.io/go-shipyard-test_repo",
		OriginalURL: "https://code.onedev.io/projects/go-shipyard-test_repo",
	}, repo)
	...
	assertPullRequestsEqual(t, []*base.PullRequest{
		{
			...
			Head: base.PullRequestBranch{
				...
				RepoName: "go-shipyard-test_repo",
			},
