...
func TestGitlabDownloadRepo(t *testing.T) {
	...
	resp, err := http.Get("https://gitlab.com/shipyard/test_repo")
	if err != nil || resp.StatusCode != http.StatusOK {
		t.Skipf("Can't access test repo, skipping %s", t.Name())
	}

	downloader, err := NewGitlabDownloader(context.Background(), "https://gitlab.com", "shipyard/test_repo", "", "", gitlabPersonalAccessToken)
	if err != nil {
	...
	assertRepositoryEqual(t, &base.Repository{
		Name:          "test_repo",
		Owner:         "",
		Description:   "Test repository for testing migration from gitlab to shipyard",
		CloneURL:      "https://gitlab.com/shipyard/test_repo.git",
		OriginalURL:   "https://gitlab.com/shipyard/test_repo",
	...
	assertPullRequestsEqual(t, []*base.PullRequest{
		{
			...
			PatchURL: "https://gitlab.com/shipyard/test_repo/-/merge_requests/2.patch",
			Head: base.PullRequestBranch{
				Ref:       "feat/test",
				CloneURL:  "https://gitlab.com/shipyard/test_repo/-/merge_requests/2",
