...
func TestGitHubDownloadRepo(t *testing.T) {
	...
	downloader := NewGithubDownloaderV3(context.Background(), "https://github.com", "", "", token, "go-shipyard", "test_repo")
	...
	assertRepositoryEqual(t, &base.Repository{
		Name:          "test_repo",
		Owner:         "go-shipyard",
		Description:   "Test repository for testing migration from github to shipyard",
		CloneURL:      "https://github.com/go-shipyard/test_repo.git",
		OriginalURL:   "https://github.com/go-shipyard/test_repo",
		DefaultBranch: "master",
	}, repo)

	topics, err := downloader.GetTopics()
	assert.NoError(t, err)
	assert.Contains(t, topics, "shipyard")
	...
	assertPullRequestsEqual(t, []*base.PullRequest{
		{
			...
			PatchURL: "https://github.com/go-shipyard/test_repo/pull/3.patch",
		...
		},
		{
			...
			PatchURL: "https://github.com/go-shipyard/test_repo/pull/4.patch",
			Head: base.PullRequestBranch{
				Ref:       "test-branch",
			...
			Comments: []*base.ReviewComment{
				{
					...
					TreePath:  "README.md",
					DiffHunk:  "@@ -1,2 +1,4 @@\n # test_repo\n Test repository for testing migration from github to shipyard\n+",
					Position:  3,
					CommitID:  "2be9101c543658591222acbee3eb799edfc3853d",
					PosterID:  81045,
