...
func TestCodebaseDownloadRepo(t *testing.T) {
	...
	cloneAddr := "https://shipyard-test.codebasehq.com/shipyard-test/test.git"
	...
	assertRepositoryEqual(t, &base.Repository{
		...
		CloneURL:    "git@codebasehq.com:shipyard-test/shipyard-test/test.git",
	...
	assertIssuesEqual(t, []*base.Issue{
		{
			...
			PosterName:  "shipyard-test-43",
			PosterEmail: "shipyard-codebase@smack.email",
			State:       "open",
