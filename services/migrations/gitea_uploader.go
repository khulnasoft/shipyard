...
import (
	...
	"github.com/khulnasoft/shipyard/modules/label"
	"github.com/khulnasoft/shipyard/modules/log"
	base "github.com/khulnasoft/shipyard/modules/migration"
	repo_module "github.com/khulnasoft/shipyard/modules/repository"
	...
	"github.com/khulnasoft/shipyard/modules/uri"
	"github.com/khulnasoft/shipyard/modules/util"
	"github.com/khulnasoft/shipyard/services/pull"
	repo_service "github.com/khulnasoft/shipyard/services/repository"

	"github.com/google/uuid"
)

var _ base.Uploader = &ShipyardLocalUploader{}

// ShipyardLocalUploader implements an Uploader to shipyard sites
type ShipyardLocalUploader struct {
	ctx            context.Context
...
// NewShipyardLocalUploader creates an shipyard Uploader via shipyard API v1
func NewShipyardLocalUploader(ctx context.Context, doer *user_model.User, repoOwner, repoName string) *ShipyardLocalUploader {
	return &ShipyardLocalUploader{
		ctx:         ctx,
		doer:        doer,
		repoOwner:   repoOwner,
		repoName:    repoName,
...
func (g *ShipyardLocalUploader) MaxBatchInsertSize(tp string) int {
	switch tp {
	case "issue":
...
func (g *ShipyardLocalUploader) CreateRepo(repo *base.Repository, opts base.MigrateOptions) error {
...
func (g *ShipyardLocalUploader) Close() {
	if g.gitRepo != nil {
		g.gitRepo.Close()
	}
}
...
func (g *ShipyardLocalUploader) CreateTopics(topics ...string) error {
...
func (g *ShipyardLocalUploader) CreateMilestones(milestones ...*base.Milestone) error {
...
func (g *ShipyardLocalUploader) CreateLabels(labels ...*base.Label) error {
...
func (g *ShipyardLocalUploader) CreateReleases(releases ...*base.Release) error {
...
func (g *ShipyardLocalUploader) SyncTags() error {
	return repo_module.SyncReleasesWithTags(g.ctx, g.repo, g.gitRepo)
}

// CreateIssues creates issues
func (g *ShipyardLocalUploader) CreateIssues(issues ...*base.Issue) error {
...
func (g *ShipyardLocalUploader) CreateComments(comments ...*base.Comment) error {
...
func (g *ShipyardLocalUploader) CreatePullRequests(prs ...*base.PullRequest) error {
...
func (g *ShipyardLocalUploader) updateGitForPullRequest(pr *base.PullRequest) (head string, err error) {
...
func (g *ShipyardLocalUploader) newPullRequest(pr *base.PullRequest) (*issues_model.PullRequest, error) {
	var labels []*issues_model.Label
...
func (g *ShipyardLocalUploader) CreateReviews(reviews ...*base.Review) error {
...
func (g *ShipyardLocalUploader) Rollback() error {
...
func (g *ShipyardLocalUploader) Finish() error {
	if g.repo == nil || g.repo.ID <= 0 {
...
func (g *ShipyardLocalUploader) remapUser(source user_model.ExternalUserMigrated, target user_model.ExternalUserRemappable) error {
	var userid int64
	var err error
	if g.sameApp {
...
func (g *ShipyardLocalUploader) remapLocalUser(source user_model.ExternalUserMigrated, target user_model.ExternalUserRemappable) (int64, error) {
...
func (g *ShipyardLocalUploader) remapExternalUser(source user_model.ExternalUserMigrated, target user_model.ExternalUserRemappable) (userid int64, err error) {
	userid, ok := g.userMap[source.GetExternalID()]
	if !ok {
