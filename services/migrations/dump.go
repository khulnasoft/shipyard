...
import (
	...
	"github.com/khulnasoft/shipyard/modules/repository"
...
// NewRepositoryDumper creates an shipyard Uploader
...
func RestoreRepository(ctx context.Context, baseDir, ownerName, repoName string, units []string, validation bool) error {
	...
	uploader := NewShipyardLocalUploader(ctx, doer, ownerName, repoName)
