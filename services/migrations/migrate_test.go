...
func TestMigrateWhiteBlocklist(t *testing.T) {
	...
	err = IsMigrateURLAllowed("https://github.com/go-shipyard/shipyard.git", nonAdminUser)
	...
	err = IsMigrateURLAllowed("https://10.0.0.1/go-shipyard/shipyard.git", nonAdminUser)
	assert.Error(t, err)
