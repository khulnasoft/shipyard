...
import (
	...
	lfs_module "github.com/khulnasoft/shipyard/modules/lfs"
		...
		if download {
			...
			if setting.LFS.Storage.MinioConfig.ServeDirect {
				...
				if u != nil && err == nil {
					...
					// https://github.com/go-shipyard/shipyard/issues/21525
...
func requireAuth(ctx *context.Context) {
	ctx.Resp.Header().Set("WWW-Authenticate", "Basic realm=shipyard-lfs")
