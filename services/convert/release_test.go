...
func TestRelease_ToRelease(t *testing.T) {
	...
	assert.EqualValues(t, "https://try.shipyard.io/api/v1/repos/user2/repo1/releases/1", apiRelease.URL)
	assert.EqualValues(t, "https://try.shipyard.io/api/v1/repos/user2/repo1/releases/1/assets", apiRelease.UploadURL)
}
