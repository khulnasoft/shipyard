...
import (
	...
	"github.com/khulnasoft/shipyard/modules/updatechecker"
	repo_service "github.com/khulnasoft/shipyard/services/repository"
	archiver_service "github.com/khulnasoft/shipyard/services/repository/archiver"
...
func registerUpdateShipyardChecker() {
	...
	RegisterTaskFatal("update_checker", &UpdateCheckerConfig{
		...
		HTTPEndpoint: "https://dl.shipyard.khulnasoft.com/shipyard/version.json",
	}, func(ctx context.Context, _ *user_model.User, config Config) error {
		updateCheckerConfig := config.(*UpdateCheckerConfig)
		return updatechecker.ShipyardUpdateChecker(updateCheckerConfig.HTTPEndpoint)
	})
}
