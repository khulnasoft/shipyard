...
func TestRegisterForm_IsDomainAllowed_InvalidEmail(t *testing.T) {
	...
	setting.Service.EmailDomainAllowList = []glob.Glob{glob.MustCompile("shipyard.io")}
...
func TestRegisterForm_IsDomainAllowed_AllowedEmail(t *testing.T) {
	...
	setting.Service.EmailDomainAllowList = []glob.Glob{glob.MustCompile("shipyard.io"), glob.MustCompile("*.allow")}

	tt := []struct {
		email string
		valid bool
	}{
		{"security@shipyard.io", true},
...
func TestRegisterForm_IsDomainAllowed_BlockedEmail(t *testing.T) {
	...
	setting.Service.EmailDomainAllowList = nil
	setting.Service.EmailDomainBlockList = []glob.Glob{glob.MustCompile("shipyard.io"), glob.MustCompile("*.block")}

	tt := []struct {
		email string
		valid bool
	}{
		{"security@shipyard.io", false},
		{"security@shipyard.example", true},
		{"invalid", true},
