...
import (
	...
	"github.com/khulnasoft/shipyard/services/auth/source/smtp"

	_ "github.com/khulnasoft/shipyard/services/auth/source/db"   // register the sources (and below)
	_ "github.com/khulnasoft/shipyard/services/auth/source/ldap" // register the ldap source
	_ "github.com/khulnasoft/shipyard/services/auth/source/pam"  // register the pam source
	_ "github.com/khulnasoft/shipyard/services/auth/source/sspi" // register the sspi source
)
