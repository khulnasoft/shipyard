...
func prepareMailerTest(t *testing.T) (doer *user_model.User, repo *repo_model.Repository, issue *issues_model.Issue, comment *issues_model.Comment) {
	...
	mailService := setting.Mailer{
		From: "test@shipyard.khulnasoft.com",
	}
...
func TestComposeIssueCommentMessage(t *testing.T) {
	...
	recipients := []*user_model.User{{Name: "Test", Email: "test@shipyard.khulnasoft.com"}, {Name: "Test2", Email: "test2@shipyard.khulnasoft.com"}}
...
func TestTemplateSelection(t *testing.T) {
	...
	recipients := []*user_model.User{{Name: "Test", Email: "test@shipyard.khulnasoft.com"}}
...
func TestGenerateAdditionalHeaders(t *testing.T) {
	...
	recipient := &user_model.User{Name: "Test", Email: "test@shipyard.khulnasoft.com"}

	headers := generateAdditionalHeaders(ctx, "dummy-reason", recipient)

	expected := map[string]string{
		"List-ID":                      "user2/repo1 <repo1.user2.localhost>",
		"List-Archive":                 "<https://try.shipyard.io/user2/repo1>",
		"X-Shipyard-Reason":            "dummy-reason",
		"X-Shipyard-Sender":            "< U<se>r Tw<o > ><",
		"X-Shipyard-Recipient":         "Test",
		"X-Shipyard-Recipient-Address": "test@shipyard.khulnasoft.com",
		"X-Shipyard-Repository":        "repo1",
		"X-Shipyard-Repository-Path":   "user2/repo1",
		"X-Shipyard-Repository-Link":   "https://try.shipyard.io/user2/repo1",
		"X-Shipyard-Issue-ID":          "1",
		"X-Shipyard-Issue-Link":        "https://try.shipyard.io/user2/repo1/issues/1",
	}
