  ...
  <div class="critical-error-wrap" v-if="shouldShow">
    ...
    <ul>
      <li>Check the browser console for more details
        (<a href="https://github.com/khulnaSoft/shipyard/blob/master/docs/troubleshooting.md#how-to-open-browser-console">see how</a>)
      </li>
      <li>View the
      ...
      <li>
        ...
        then <a href="https://github.com/khulnaSoft/shipyard/issues/new/choose">open a ticket on GitHub</a>
      </li>
