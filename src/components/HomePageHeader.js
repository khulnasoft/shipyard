  ...
  return (
    <header className={styles.heroBanner}>
      ...
      <div className={styles.buttons}>
        ...
        <Button to="https://demo.ship.khulnasoft.com" color="blue"><IconBannerDemo />Live Demo</Button>
        <Button to="https://github.com/khulnasoft/shipyard" color="green"><IconBannerSource />Source Code</Button>
        <Button to="/docs" color="yellow"><IconBannerDocs />Documentation</Button>
      </div>
      <div className={styles.shipyardDescription}>
        Shipyard is an open source, highly customizable, easy to use, privacy-respecting dashboard app.
        {showMore && (
          <p className={styles.shipyardDescription}>
        ...
        <div className={styles.sponsor}>
          <span>
            Shipyard is kindly sponsored by <a href="https://umbrel.com?ref=shipyard" target="_blank">Umbrel</a> -
            the personal home cloud and OS for self-hosting
          </span>
          <a href="https://umbrel.com?ref=shipyard" target="_blank">
      ...
      <a href="https://github.com/khulnasoft/shipyard">
        <img className={styles.starButton}
          src="https://img.shields.io/github/stars/khulnasoft/Shipyard?label=Shipyard%20on%20GitHub&logo=github&style=social"
        />
      </a>
    </header>
  );
