...
const DocsLinks = [
  {
    title: 'Deployment',
    description: 'Getting Shipyard up and running',
...
const DocsSections = [
  {
    section: 'Running Shipyard',
    items: [
      {
        title: 'Quick-Start',
        description: 'TLDR Guide on running Shipyard',
        link: '/docs/quick-start',
        icon: (<IconQuickStart />),
      },
      {
        title: 'Deployment',
        description: 'Deploying Shipyard to any server',
        link: '/docs/deployment',
        icon: (<IconDeploy />),
      },
      {
  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        description: 'Monitoring uptime of your services with Shipyard',
      ...
      {
        title: 'Theming',
        description: 'Guide to customizing the look and feel of Shipyard',
        link: '/docs/theming',
        icon: (<IconTheming />),
      },
      {
  ...
  },
  {
    ...
    items: [
      {
        title: 'Developing',
        description: 'Shipyard workflow, and running locally',
      ...
      {
        title: 'Contributing',
        description: 'How you can help support Shipyard\'s development',
        link: '/docs/contributing',
        icon: (<IconContributing />),
      },
      {
        title: 'Showcase',
        description: 'See how others are using Shipyard, and share your dashboard',
        link: '/docs/showcase',
        icon: (<IconShowcase />),
      },
      {
        title: 'Credits',
        description: 'List of people and projects that have made Shipyard possible',
        link: '/docs/credits',
        icon: (<IconCredits />),
      },
    ]
  },
  {
    ...
    items: [
      ...
      {
        title: 'License',
        description: 'Licensing model of Shipyard',
        link: '/docs/license',
        icon: (<IconLegal />),
      },
      {
        title: 'Code of Conduct',
        description: 'Guidelines around Shipyard',
...
export default function Docs() {
  ...
  return (
    <Layout
      ...
      <main className="docs">
        <h1 className="docs-title">Shipyard Docs</h1>
        <p className="see-repo-note">
          <span>Note, for the most up-to-date documentation, please see the </span> 
          <a href="https://github.com/khulnasoft/shipyard/tree/master/docs">GitHub repository</a>
        </p>
