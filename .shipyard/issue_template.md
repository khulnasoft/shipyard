...
- Shipyard version (or commit ref):
- Git version:
- Operating system:
  <!-- Please include information on whether you built shipyard yourself, used one of our downloads or are using some other package -->
...
- Database (use `[x]`):
  ...
  - [ ] MSSQL
  - [ ] SQLite
- Can you reproduce the bug at https://try.shipyard.io:
...
## Description
<!-- If using a proxy or a CDN (e.g. CloudFlare) in front of shipyard, please
     disable the proxy/CDN fully and connect to shipyard directly to confirm
