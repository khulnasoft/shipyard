...
def main():
    ...
    os.environ["SHIPYARD_CLI"] = "1"

    # config profiles are the first thing that need to be loaded (especially before shipyard.config!)
    from .profiles import set_profile_from_sys_argv

    set_profile_from_sys_argv()

    # initialize CLI plugins
    from .shipyard import create_with_plugins
