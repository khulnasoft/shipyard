...
from shipyard.utils.bootstrap import Container, RunningContainer, get_docker_image_to_start
...
"""Environment variable used to indicate that we should mount shipyard source files into the container."""
    ...
    def __call__(
        ...
        **kwargs,
        ...
        if pro:
            ...
            container_configuration.env_vars["SHIPYARD_API_KEY"] = os.environ.get(
                "SHIPYARD_API_KEY", "test"
            )
...
def dns_query_from_container(container_factory: ContainerFactory, monkeypatch):
    """
    Run the Shipyard container after installing dig
    """
...
def stream_container_logs() -> Generator[LogStreamFactory, None, None]:
    ...
    ``containers.<container-name>``. You can find it in the logs as::
        ...
        2023-09-03T18:49:06.236 DEBUG --- [log-stream-1] container.shipyard-5a4c3678 : foobar
        2023-09-03T18:49:06.236 DEBUG --- [log-stream-1] container.shipyard-5a4c3678 : hello world
