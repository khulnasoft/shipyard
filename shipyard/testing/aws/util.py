...
from shipyard.aws.forwarder import create_http_request
from shipyard.aws.protocol.parser import create_parser
from shipyard.aws.proxy import get_account_id_from_request
from shipyard.aws.spec import SHIPYARD_BUILTIN_DATA_PATH, load_service
...
# Supports test executions against both Shipyard and production AWS
...
def base_aws_session() -> boto3.Session:
    ...
    session._loader.search_paths.append(SHIPYARD_BUILTIN_DATA_PATH)
    return session
