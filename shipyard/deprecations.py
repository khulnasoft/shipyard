...
from shipyard.utils.analytics import log
...
#
# Please make sure this is in-sync with https://docs.shipyard.khulnasoft.com/references/configuration/
#
DEPRECATIONS = [
    ...
    EnvVarDeprecation(
        "USE_SINGLE_REGION",
        "0.12.7",
        "Shipyard now has full multi-region support. This option has no effect. Please remove it from your configuration.",  # noqa
    ),
    # Deprecated in 0.12.7, removed in 3.0.0
    EnvVarDeprecation(
        "DEFAULT_REGION",
    ...
    EnvVarDeprecation(
        "DATA_DIR",
        "1.0.0",
        "Please use PERSISTENCE instead. The state will be stored in your Shipyard volume in the state/ directory.",
    ),
    EnvVarDeprecation(
        "HOST_TMP_FOLDER",
        "1.0.0",
    ...
    EnvVarDeprecation(
        ...
        "1.0.0",
        "The legacy persistence mechanism is not supported anymore, please migrate to the advanced persistence mechanism of Shipyard Pro.",  # noqa
    ),
    ...
    # Since 2.0.0 - HOSTNAME_EXTERNAL will be replaced with SHIPYARD_HOST
    EnvVarDeprecation(
        "HOSTNAME_EXTERNAL",
        "2.0.0",
        "This configuration will be migrated to SHIPYARD_HOST",
    ),
    # Since 2.0.0 - SHIPYARD_HOST will be replaced with SHIPYARD_HOST
    EnvVarDeprecation(
        "SHIPYARD_HOSTNAME",
        "2.0.0",
        "This configuration will be migrated to SHIPYARD_HOST",
    ...
    EnvVarDeprecation(
        ...
        "https://docs.shipyard.khulnasoft.com/user-guide/aws/lambda/#migrating-to-lambda-v2\n"
        "Please mount the Docker socket /var/run/docker.sock as a volume when starting Shipyard.",
    ),
    EnvVarDeprecation(
    ...
    EnvVarDeprecation(
        "SQS_PORT_EXTERNAL",
        "1.0.0",
        "This option has no effect anymore. Please use SHIPYARD_HOST instead.",
    ),
    EnvVarDeprecation(
...
def log_env_warning(deprecations: List[EnvVarDeprecation]) -> None:
    ...
    if deprecations:
        ...
        for deprecation in deprecations:
            LOG.warning(
                "%s is deprecated (since %s) and will be removed in upcoming releases of Shipyard! %s",
                deprecation.env_var,
...
def deprecated_endpoint(
    ...
    :param deprecation_version: version of Shipyard with which this endpoint is deprecated
    ...
    def deprecated_wrapper(*args, **kwargs):
        LOG.warning(
            "%s is deprecated (since %s) and will be removed in upcoming releases of Shipyard! Use %s instead.",
            previous_path,
            deprecation_version,
            new_path,
        )
