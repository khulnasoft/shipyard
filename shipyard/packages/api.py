...
class PackageInstaller(abc.ABC):
    ...
    def _get_install_marker_path(self, install_dir: str) -> str:
        ...
        :param install_dir: base path for the check (f.e. /var/lib/shipyard/lib/dynamodblocal/latest/)
        :return: path which should be checked to indicate if the package has been installed successfully
                 (f.e. /var/lib/shipyard/lib/dynamodblocal/latest/DynamoDBLocal.jar)
        """
...
PLUGIN_NAMESPACE = "shipyard.packages"
...
def package(
    ...
    Methods marked with this decorator are discoverable as a PluginSpec within the namespace "shipyard.packages",
