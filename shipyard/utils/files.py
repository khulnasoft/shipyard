...
def get_user_cache_dir() -> Path:
    ...
    """
    from shipyard.utils.platform import is_linux, is_mac_os, is_windows
...
def cache_dir() -> Path:
    """
    Returns the cache dir for shipyard (e.g., ~/.cache/shipyard)

    :return: a Path pointing to the shipyard cache dir
    """
    return get_user_cache_dir() / "shipyard"
