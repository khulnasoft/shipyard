...
from shipyard.utils.http import get_proxies
...
class AnalyticsClient:
    ...
    def __init__(self, api=None):
        ...
        self.shipyard_session_id = get_session_id()
    ...
    def start_session(self, metadata: ClientMetadata) -> SessionResponse:
        ...
        request = Event(
            "session", EventMetadata(self.shipyard_session_id, str(now())), payload=metadata
        )
    ...
    def _create_headers(self) -> Dict[str, str]:
        return {
            "User-Agent": "shipyard/" + constants.VERSION,
            "Shipyard-Session-ID": self.shipyard_session_id,
        }
