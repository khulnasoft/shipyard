...
from shipyard.constants import SHIPYARD_ROOT_FOLDER, SHIPYARD_VENV_FOLDER
from shipyard.utils.aws import arns
from shipyard.utils.files import TMP_FILES, chmod_r, save_file
from shipyard.utils.kinesis import kclipy_helper
from shipyard.utils.run import ShellCommandThread
from shipyard.utils.strings import short_uid, truncate
from shipyard.utils.sync import retry
from shipyard.utils.threads import TMP_THREADS, FuncThread
...
for path in glob.glob('{SHIPYARD_VENV_FOLDER}/lib/python*/site-packages'):
    sys.path.insert(0, path)
sys.path.insert(0, '{SHIPYARD_ROOT_FOLDER}')
from shipyard.config import DEFAULT_ENCODING
from shipyard.utils.kinesis import kinesis_connector
from shipyard.utils.time import timestamp
events_file = '{events_file}'
log_file = None
