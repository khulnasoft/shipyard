...
from shipyard.aws.spec import ServiceCatalog, build_service_index_cache, load_service_index_cache
from shipyard.constants import LOCALHOST_HOSTNAME, PATH_USER_REQUEST
from shipyard.http import Request
from shipyard.services.s3.utils import uses_host_addressing
from shipyard.services.sqs.utils import is_sqs_queue_url
from shipyard.utils.objects import singleton_factory
from shipyard.utils.strings import to_bytes
from shipyard.utils.urls import hostname_from_url
...
def get_service_catalog() -> ServiceCatalog:
    ...
    try:
        ls_ver = shipyard.__version__.replace(".", "_")
