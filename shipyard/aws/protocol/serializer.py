...
from shipyard.aws.api import CommonServiceException, HttpResponse, ServiceException
...
from shipyard.utils.common import to_bytes, to_str
from shipyard.utils.strings import long_uid
from shipyard.utils.xml import strip_xmlns
...
class SqsResponseSerializer(JSONResponseSerializer):
    ...
    def _serialize_error(
        ...
        # Shipyard: "InvalidParameterValue"
...
def aws_response_serializer(service: str, operation: str):
    ...
    This can be used to create AWS request handlers in a convenient way. Example usage::
        ...
        from shipyard.http import route, Request
