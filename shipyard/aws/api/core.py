...
from shipyard.aws.connect import InternalRequestParameters
from shipyard.http import Request, Response
from shipyard.utils.strings import long_uid

# FIXME: deprecated, use shipyard.http.Request and shipyard.http.Response instead
HttpRequest = Request
...
class RequestContext:
    """
    A RequestContext object holds the information of an HTTP request that is processed by the Shipyard Gateway. The
    ...
    """Data sent by client-side Shipyard during internal calls."""
