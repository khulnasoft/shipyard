...
from shipyard.aws.api.core import (
    Request,
    RequestContext,
    ServiceRequest,
...
from shipyard.aws.client import parse_response, raise_service_exception
from shipyard.aws.connect import connect_to
from shipyard.aws.skeleton import DispatchTable, create_dispatch_table
...
def create_aws_request_context(
    ...
    :param endpoint_url: the endpoint to call (defaults to shipyard)
    ...
    # The endpoint URL is mandatory here, set a dummy if not given (doesn't _need_ to be shipyard specific)
    if not endpoint_url:
        endpoint_url = "http://localhost.shipyard.khulnasoft.com"
