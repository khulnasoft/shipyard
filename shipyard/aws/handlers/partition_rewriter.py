...
from shipyard.http.proxy import forward
from shipyard.http.request import Request, get_full_raw_path, get_raw_path, restore_payload
from shipyard.utils.aws.aws_responses import calculate_crc32
...
class ArnPartitionRewriteHandler(Handler):
    ...
    aws-us-gov) without
    rewriting all the cases where the ARN is parsed or constructed within Shipyard or moto.
