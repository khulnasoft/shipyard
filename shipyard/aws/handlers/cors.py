...
from shipyard.config import EXTRA_CORS_ALLOWED_HEADERS, EXTRA_CORS_EXPOSE_HEADERS
from shipyard.constants import LOCALHOST, LOCALHOST_HOSTNAME, PATH_USER_REQUEST
...
def _get_allowed_cors_internal_domains() -> Set[str]:
    ...
    """
    return {LOCALHOST, LOCALHOST_HOSTNAME, shipyard_host().host}
...
def _get_allowed_cors_origins() -> List[str]:
    ...
    result = [
        ...
        "https://app.shipyard.khulnasoft.com",
        "http://app.shipyard.khulnasoft.com",
        "https://localhost",
        "https://localhost.shipyard.khulnasoft.com",
