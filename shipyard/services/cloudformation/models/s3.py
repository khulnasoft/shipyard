...
from shipyard.config import S3_STATIC_WEBSITE_HOSTNAME, S3_VIRTUAL_HOSTNAME
from shipyard.services.cloudformation.cfn_utils import rename_params
from shipyard.services.cloudformation.deployment_utils import (
    dump_json_params,
    generate_default_name,
)
from shipyard.services.cloudformation.service_models import GenericBaseModel
from shipyard.services.s3.utils import normalize_bucket_name
from shipyard.utils.aws import arns
from shipyard.utils.common import canonical_json, md5
from shipyard.utils.testutil import delete_all_s3_objects
...
class S3Bucket(GenericBaseModel):
    ...
    def get_deploy_templates(cls):
        ...
        def _handle_result(
            ...
            resource["Properties"][
                "WebsiteURL"
            ] = f"http://{bucket_name}.{S3_STATIC_WEBSITE_HOSTNAME}:{shipyard_host().port}"
