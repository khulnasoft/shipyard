...
SHIPYARD_ROOT_DIR = Path(__file__).parent.joinpath("../../../..").resolve()
SHIPYARD_PRO_ROOT_DIR = SHIPYARD_ROOT_DIR.joinpath("../shipyard-ext").resolve()
TESTS_ROOT_DIR = SHIPYARD_ROOT_DIR.joinpath(
    "tests/aws/services/cloudformation/resource_providers"
)
TESTS_PRO_ROOT_DIR = SHIPYARD_PRO_ROOT_DIR.joinpath(
    "tests/aws/services/cloudformation/resource_providers"
)

assert SHIPYARD_ROOT_DIR.is_dir(), f"{SHIPYARD_ROOT_DIR} does not exist"
assert SHIPYARD_PRO_ROOT_DIR.is_dir(), f"{SHIPYARD_PRO_ROOT_DIR} does not exist"
...
def root_dir(pro: bool = False) -> Path:
    if pro:
        return SHIPYARD_PRO_ROOT_DIR
    else:
        return SHIPYARD_ROOT_DIR
    ...
    def __init__(
        ...
        self.destination_files = {
            FileType.provider: root_dir(self.pro).joinpath(
                "shipyard_ext" if self.pro else "shipyard",
                "services",
