...
from shipyard.services.cloudformation import usage
...
from shipyard.services.cloudformation.engine.quirks import PHYSICAL_RESOURCE_ID_SPECIAL_CASES
from shipyard.services.cloudformation.service_models import KEY_RESOURCE_STATE, GenericBaseModel

PRO_RESOURCE_PROVIDERS = False
try:
    from shipyard_ext.services.cloudformation.resource_provider import (
...
if TYPE_CHECKING:
    from shipyard.services.cloudformation.engine.types import (
        FuncDetails,
        FuncDetailsValue,
        ResourceDefinition,
    )
...
class CloudFormationResourceProviderPlugin(Plugin):
    ...
    namespace = "shipyard.khulnasoft.comformation.resource_providers"
