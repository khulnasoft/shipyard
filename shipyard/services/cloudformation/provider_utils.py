...
Avoid any imports to shipyard here and keep external imports to a minimum!
This is because we want to be able to package a resource provider without including shipyard code.
"""
import builtins
import json
import re
