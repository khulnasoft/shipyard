...
class AwsIncludeTransformer(Transformer):
    ...
    def transform(self, account_id: str, region_name: str, parameters: dict) -> TransformResult:
        from shipyard.services.cloudformation.engine.template_preparer import parse_template
...
def apply_transform_intrinsic_functions(
    ...
    from shipyard.services.cloudformation.engine.template_deployer import resolve_refs_recursively
