...
from shipyard.services.cloudformation.deployment_utils import PLACEHOLDER_AWS_NO_VALUE
from shipyard.utils.urls import shipyard_host

AWS_URL_SUFFIX = shipyard_host().host  # value is "amazonaws.com" in real AWS
