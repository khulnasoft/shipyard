...
def get_template_body(req_data: dict) -> str:
    ...
    if url:
        ...
        # check error codes, and code 301 - fixes https://github.com/khulnasoft/shipyard/issues/1884
...
def convert_s3_to_local_url(url: str) -> str:
    from shipyard.services.cloudformation.provider import ValidationError
