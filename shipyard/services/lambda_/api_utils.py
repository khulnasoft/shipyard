...
from shipyard.aws.api import lambda_ as api_spec
...
from shipyard.services.lambda_.runtimes import ALL_RUNTIMES, VALID_LAYER_RUNTIMES, VALID_RUNTIMES
...
# An unordered list of all Lambda CPU architectures supported by Shipyard.
