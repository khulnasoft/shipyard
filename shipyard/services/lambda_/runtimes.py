...
# 1. Update botocore and generate the Lambda API stubs using `python3 -m shipyard.aws.scaffold upgrade`
...
# 8. Add the new runtime to the K8 image build: https://github.com/khulnasoft/lambda-cve-mitigation
...
# An unordered list of all deprecated Lambda runtimes that are still supported in Shipyard.
...
# An unordered list of all Lambda runtimes supported by Shipyard.
