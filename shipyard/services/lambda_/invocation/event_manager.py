...
from shipyard.aws.api.lambda_ import TooManyRequestsException
...
from shipyard.utils.aws import dead_letter_queue
from shipyard.utils.aws.message_forwarding import send_event_to_target
from shipyard.utils.strings import md5, to_str
...
CLIENT_CONFIG = Config(
    # We shut down the Shipyard gateway last, hence this does not delay Shipyard cleanup anymore
    connect_timeout=60,
    read_timeout=60,
