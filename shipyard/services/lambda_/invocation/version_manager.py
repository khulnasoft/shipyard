...
from shipyard.services.lambda_.invocation.execution_environment import ExecutionEnvironment
from shipyard.services.lambda_.invocation.executor_endpoint import StatusErrorException
...
from shipyard.services.lambda_.invocation.logs import LogHandler, LogItem
from shipyard.services.lambda_.invocation.metrics import (
...
from shipyard.utils.threads import FuncThread, start_thread
...
class LambdaVersionManager:
    ...
    def update_provisioned_concurrency_config(
        ...
        with self.provisioned_state_lock:
            # Shipyard limitation: cannot update provisioned concurrency while another update is in progress
            if (
