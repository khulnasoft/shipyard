...
The LambdaProviderPro in shipyard-ext imports this model and configures persistence.
...
from shipyard.services.lambda_.api_utils import qualified_lambda_arn, unqualified_lambda_arn
