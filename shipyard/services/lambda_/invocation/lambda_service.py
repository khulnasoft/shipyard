...
from shipyard.services.lambda_ import usage
from shipyard.services.lambda_.api_utils import (
    lambda_arn,
    qualified_lambda_arn,
    qualifier_is_alias,
)
from shipyard.services.lambda_.invocation.assignment import AssignmentService
from shipyard.services.lambda_.invocation.counting_service import CountingService
from shipyard.services.lambda_.invocation.event_manager import LambdaEventManager
...
from shipyard.services.lambda_.invocation.models import lambda_stores
from shipyard.services.lambda_.invocation.version_manager import LambdaVersionManager
from shipyard.services.lambda_.lambda_utils import HINT_LOG
from shipyard.utils.archives import get_unzipped_size, is_zip_file
        ...
        try:
            ...
            if state == State.Failed:
                HINT_LOG.error(
                    ...
                    "Please ensure that Docker is available in the Shipyard container by adding the volume mount "
                    '"/var/run/docker.sock:/var/run/docker.sock" to your Shipyard startup. '
                    "Check out https://docs.shipyard.khulnasoft.com/user-guide/aws/lambda/#docker-not-available"
                )
                ...
                HINT_LOG.warning(
                    ...
                    "Check out https://docs.shipyard.khulnasoft.com/user-guide/aws/lambda/#function-in-pending-state"
                )
