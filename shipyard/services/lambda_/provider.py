...
from shipyard.aws.api import RequestContext, ServiceException, handler
from shipyard.aws.api.lambda_ import (
    AccountLimit,
    AccountUsage,
...
from shipyard.aws.api.lambda_ import FunctionVersion as FunctionVersionApi
from shipyard.aws.api.lambda_ import ServiceException as LambdaServiceException
from shipyard.aws.connect import connect_to
from shipyard.services.edge import ROUTER
from shipyard.services.lambda_ import api_utils
from shipyard.services.lambda_ import hooks as lambda_hooks
from shipyard.services.lambda_.api_utils import (
    ARCHITECTURES,
    STATEMENT_ID_REGEX,
    function_locators_from_arn,
)
from shipyard.services.lambda_.event_source_listeners.event_source_listener import (
    EventSourceListener,
)
from shipyard.services.lambda_.event_source_listeners.utils import validate_filters
from shipyard.services.lambda_.invocation import AccessDeniedException
from shipyard.services.lambda_.invocation.execution_environment import (
    EnvironmentStartupTimeoutException,
)
from shipyard.services.lambda_.invocation.lambda_models import (
    AliasRoutingConfig,
    CodeSigningConfig,
    EventInvokeConfig,
    Function,
...
from shipyard.services.lambda_.invocation.lambda_service import (
    LambdaService,
    create_image_code,
...
from shipyard.services.lambda_.invocation.models import LambdaStore
from shipyard.services.lambda_.invocation.runtime_executor import get_runtime_executor
from shipyard.services.lambda_.layerfetcher.layer_fetcher import LayerFetcher
from shipyard.services.lambda_.runtimes import (
    ALL_RUNTIMES,
    DEPRECATED_RUNTIMES,
    SNAP_START_SUPPORTED_RUNTIMES,
    VALID_RUNTIMES,
)
from shipyard.services.lambda_.urlrouter import FunctionUrlRouter
from shipyard.services.plugins import ServiceLifecycleHook
from shipyard.state import StateVisitor
from shipyard.utils.aws.arns import extract_service_from_arn
from shipyard.utils.bootstrap import is_api_enabled
from shipyard.utils.collections import PaginatedList
from shipyard.utils.files import load_file
from shipyard.utils.strings import get_random_hex, long_uid, short_uid, to_bytes, to_str
from shipyard.utils.sync import poll_condition
from shipyard.utils.urls import shipyard_host
...
class LambdaProvider(LambdaApi, ServiceLifecycleHook):
    ...
    def invoke(
        ...
        try:
            ...
            if "shipyard-internal-awssdk" in function_name:
                ...
                lambda_client.create_function(
                    FunctionName="shipyard-internal-awssdk",
    ...
    def create_function_url_config(
        ...
        host_definition = shipyard_host(custom_port=config.GATEWAY_LISTEN[0].port)
