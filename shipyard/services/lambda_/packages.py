...
from shipyard.packages import DownloadInstaller, InstallTarget, Package, PackageInstaller
from shipyard.utils.platform import get_arch

"""Customized Shipyard version of the AWS Lambda Runtime Interface Emulator (RIE).
https://github.com/khulnasoft/lambda-runtime-init/blob/shipyard/README-SHIPYARD.md
"""
...
LAMBDA_RUNTIME_INIT_URL = "https://github.com/khulnasoft/lambda-runtime-init/releases/download/{version}/aws-lambda-rie-{arch}"

"""Unmaintained Java utilities and JUnit integration for Shipyard released to Maven Central.
https://github.com/khulnasoft/shipyard-java-utils
We recommend the Testcontainers Shipyard Java module as an alternative:
https://java.testcontainers.org/modules/shipyard/
"""
SHIPYARD_MAVEN_VERSION = "0.2.21"
MAVEN_REPO_URL = "https://repo1.maven.org/maven2"
URL_SHIPYARD_FAT_JAR = (
    "{mvn_repo}/cloud/khulnasoft/shipyard-utils/{ver}/shipyard-utils-{ver}-fat.jar"
)
...
# TODO: replace usage in Shipyard tests with locally built Java jar and remove this unmaintained dependency.
...
class LambdaJavaPackageInstaller(DownloadInstaller):
    def _get_download_url(self) -> str:
        return URL_SHIPYARD_FAT_JAR.format(ver=self.version, mvn_repo=MAVEN_REPO_URL)
