...
from shipyard.constants import ARTIFACTS_REPO, MAVEN_REPO_URL
from shipyard.packages import InstallTarget, Package, PackageInstaller
from shipyard.packages.core import ExecutableInstaller
from shipyard.utils.archives import add_file_to_jar, untar, update_jar_manifest
from shipyard.utils.files import file_exists_not_empty, mkdir, new_tmp_file, rm_rf
from shipyard.utils.http import download
...
SFN_PATCH_CLASS_STARTER = "cloud/shipyard/StepFunctionsStarter.class"
SFN_PATCH_CLASS_REGION = "cloud/shipyard/RegionAspect.class"
SFN_PATCH_CLASS_ASYNC2SERVICEAPI = "cloud/shipyard/Async2ServiceApi.class"
SFN_PATCH_CLASS_DESCRIBEEXECUTIONPARSED = "cloud/shipyard/DescribeExecutionParsed.class"
...
This digest pin defines the version of StepFunctionsLocal used in Shipyard.
...
class StepFunctionsLocalPackageInstaller(ExecutableInstaller):
    ...
    def _install(self, target: InstallTarget) -> None:
        ...
        update_jar_manifest(
            ...
            "Main-Class: cloud.shipyard.StepFunctionsStarter",
        )
        ...
        target = os.path.join(install_dir, "shipyard-internal-awssdk", "awssdk.zip")
