...
from shipyard import __version__ as shipyard_version
...
from shipyard.aws.forwarder import (
    ForwardingFallbackDispatcher,
    create_aws_request_context,
    dispatch_to_backend,
)
from shipyard.aws.skeleton import DispatchTable
from shipyard.constants import DEFAULT_AWS_ACCOUNT_ID
from shipyard.http import Response
from shipyard.http.request import get_full_raw_path, get_raw_current_url

MotoDispatcher = Callable[[HttpRequest, str, dict], Response]

user_agent = f"Shipyard/{shipyard_version} Python/{sys.version.split(' ')[0]}"
