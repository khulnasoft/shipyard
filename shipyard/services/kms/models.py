...
from shipyard.services.kms.utils import is_valid_key_arn
from shipyard.services.stores import AccountRegionBundle, BaseStore, LocalAttribute
from shipyard.utils.aws.arns import kms_alias_arn, kms_key_arn
from shipyard.utils.crypto import decrypt, encrypt
...
class KmsCryptoKey:
    ...
    def __init__(self, key_spec: str):
        ...
        # But Shipyard uses symmetric encryption with this key_material even for other specs. Asymmetric keys are
...
class KmsKey:
    ...
    def schedule_key_deletion(self, pending_window_in_days: int) -> None:
        ...
        #  notion of a primary key in Shipyard. Might be useful to improve it.
