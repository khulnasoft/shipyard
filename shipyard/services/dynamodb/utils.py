...
from shipyard.aws.api.dynamodb import ResourceNotFoundException
from shipyard.aws.connect import connect_to
from shipyard.constants import TEST_AWS_SECRET_ACCESS_KEY
from shipyard.utils.aws.arns import dynamodb_table_arn
from shipyard.utils.json import canonical_json
from shipyard.utils.testutil import list_all_resources
...
class SchemaExtractor:
    ...
    def get_key_schema(
        ...
        from shipyard.services.dynamodb.provider import get_store
...
class ItemFinder:
    ...
    def find_existing_item(
        ...
        from shipyard.services.dynamodb.provider import ValidationException
