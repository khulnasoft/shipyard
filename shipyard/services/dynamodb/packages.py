...
from shipyard.utils.archives import (
    download_and_extract_with_retry,
    update_jar_manifest,
    upgrade_jar_file,
)
from shipyard.utils.files import file_exists_not_empty, save_file
from shipyard.utils.functions import run_safe
from shipyard.utils.http import download
from shipyard.utils.platform import get_arch, is_mac_os
...
class DynamoDBLocalPackageInstaller(PackageInstaller):
    ...
    def _install(self, target: InstallTarget):
        ...
        tmp_archive = os.path.join(config.dirs.cache, "shipyard.ddb.zip")
