...
from shipyard.aws.api.events import PutEventsRequestEntry
...
from shipyard.config import LEGACY_V2_S3_PROVIDER
from shipyard.services.s3.utils import _create_invalid_argument_exc
from shipyard.services.s3.v3.models import S3Bucket, S3DeleteMarker, S3Object
from shipyard.utils.aws import arns
from shipyard.utils.aws.arns import parse_arn, s3_bucket_arn
...
from shipyard.utils.time import parse_timestamp, timestamp_millis

if LEGACY_V2_S3_PROVIDER:
    from moto.s3.models import FakeBucket, FakeDeleteMarker, FakeKey

    from shipyard.services.s3.models import get_moto_s3_backend
