...
from shipyard.aws.api import CommonServiceException, RequestContext, ServiceException, handler
from shipyard.aws.api.s3 import (
    MFA,
    AccountId,
...
from shipyard.aws.forwarder import NotImplementedAvoidFallbackError
from shipyard.aws.handlers import preprocess_request, serve_custom_service_request_handlers
from shipyard.constants import AWS_REGION_US_EAST_1, DEFAULT_AWS_ACCOUNT_ID
...
from shipyard.services.s3.cors import S3CorsHandler, s3_cors_request_handler
from shipyard.services.s3.exceptions import (
    InvalidRequest,
    MalformedXML,
    NoSuchConfiguration,
    UnexpectedContent,
)
from shipyard.services.s3.models import BucketCorsIndex, S3Store, get_moto_s3_backend, s3_stores
from shipyard.services.s3.notifications import NotificationDispatcher, S3EventNotificationContext
from shipyard.services.s3.presigned_url import validate_post_policy
...
from shipyard.services.s3.utils_moto import (
    get_bucket_from_moto,
    get_key_from_moto_bucket,
    is_moto_key_expired,
)
from shipyard.services.s3.validation import (
...
from shipyard.services.s3.website_hosting import register_website_hosting_routes
from shipyard.utils.aws import arns
from shipyard.utils.aws.arns import s3_bucket_name
from shipyard.utils.collections import get_safe
from shipyard.utils.patch import patch
from shipyard.utils.strings import short_uid
from shipyard.utils.time import parse_timestamp
...
] = f"s3.{shipyard_host().host_and_port()},s3.{shipyard_host().host}"
...
class S3Provider(S3Api, ServiceLifecycleHook):
    ...
    def restore_object(
        ...
        # But because it's instant in Shipyard, we can directly send the Completed notification as well
...
def apply_moto_patches():
    # importing here in case we need InvalidObjectState from `shipyard.aws.api.s3`
