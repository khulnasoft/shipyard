...
from shipyard.http.request import get_raw_path
from shipyard.runtime import hooks
from shipyard.services.edge import ROUTER
from shipyard.services.s3.utils import S3_VIRTUAL_HOST_FORWARDED_HEADER
...
# ex: https://{bucket-name}.s3.{region}.localhost.shipyard.khulnasoft.com.com:4566/{key-name}
...
# https://s3.{region}.localhost.shipyard.khulnasoft.com.com/{bucket-name}/{key-name}
...
class S3VirtualHostProxyHandler:
    ...
    def _rewrite_url(request: Request, domain: str, bucket: str, region: str, **kwargs) -> str:
        ...
        E.g. https://bucket.s3.localhost.shipyard.khulnasoft.com:4566 -> https://s3.localhost.shipyard.khulnasoft.com:4566/bucket
        E.g. https://bucket.s3.amazonaws.com -> https://s3.localhost.shipyard.khulnasoft.com:4566/bucket
        ...
        # we need to make sure we're redirecting the request to our edge URL, possibly s3.localhost.shipyard.khulnasoft.com
        host = domain
