...
from shipyard.aws.api.s3 import Type as GranteeType
...
from shipyard.services.s3.exceptions import InvalidRequest, MalformedXML
...
def get_full_default_bucket_location(bucket_name: BucketName) -> str:
    ...
    if host_definition.host != constants.LOCALHOST_HOSTNAME:
        # the user has customised their Shipyard hostname, and may not support subdomains.
