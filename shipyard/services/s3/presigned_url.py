...
from shipyard.aws.protocol.op_router import RestServiceOperationRouter
from shipyard.aws.protocol.service_router import get_service_catalog
from shipyard.constants import TEST_AWS_ACCESS_KEY_ID, TEST_AWS_SECRET_ACCESS_KEY
from shipyard.http import Request, Response
from shipyard.http.request import get_raw_path
from shipyard.services.s3.constants import SIGNATURE_V2_PARAMS, SIGNATURE_V4_PARAMS
...
def _find_valid_signature_through_ports(context: RequestContext) -> FindSigV4Result:
    """
    Tries to validate the signature of the received request. If it fails, it will iterate through known Shipyard
