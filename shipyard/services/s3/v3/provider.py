...
from shipyard.aws.api import CommonServiceException, RequestContext, handler
...
from shipyard.constants import AWS_REGION_US_EAST_1
...
from shipyard.services.s3.constants import (
...
from shipyard.services.s3.v3.models import (
    BucketCorsIndex,
...
from shipyard.services.s3.v3.storage.core import LimitedIterableStream, S3ObjectStore
...
DEFAULT_S3_TMP_DIR = "/tmp/shipyard-s3-storage"
...
class S3Provider(S3Api, ServiceLifecycleHook):
    ...
    def restore_object(
        ...
        if not restore_days:
            LOG.debug("Shipyard does not support restore SELECT requests yet.")
