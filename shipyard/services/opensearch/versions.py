...
the latest install_versions from the github repository tags. Run::
    ...
    python -m shipyard.services.opensearch.versions
...
from shipyard.aws.api.opensearch import CompatibleVersionsMap, EngineType
from shipyard.utils.common import get_arch
