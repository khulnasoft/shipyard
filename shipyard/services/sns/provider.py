...
from shipyard.aws.api import CommonServiceException, RequestContext
from shipyard.aws.api.sns import (
    AmazonResourceName,
...
from shipyard.http import Request, Response, Router, route
...
from shipyard.services.sns.models import SnsMessage, SnsStore, SnsSubscription, sns_stores
from shipyard.services.sns.publisher import (
    PublishDispatcher,
...
class SnsProvider(SnsApi, ServiceLifecycleHook):
    ...
    def subscribe(
        ...
        # Send out confirmation message for HTTP(S), fix for https://github.com/khulnasoft/shipyard/issues/881
...
def register_sns_api_resource(router: Router):
    """Register the retrospection endpoints as internal Shipyard endpoints."""
