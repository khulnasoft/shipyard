...
from shipyard.aws.api.logs import (
    AmazonResourceName,
...
from shipyard.services.logs.models import get_moto_logs_backend, logs_stores
...
from shipyard.utils.common import is_number
...
def moto_to_describe_dict(target, self):
    # reported race condition in https://github.com/khulnasoft/shipyard/issues/8011
