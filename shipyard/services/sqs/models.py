...
from shipyard.services.sqs.exceptions import (
...
class SqsQueue:
    ...
    def url(self, context: RequestContext) -> str:
        ...
        * (standard) http://sqs.eu-west-1.localhost.shipyard.khulnasoft.com:4566/000000000000/myqueue
        * (domain) http://eu-west-1.queue.localhost.shipyard.khulnasoft.com:4566/000000000000/myqueue
        * (path) http://localhost.shipyard.khulnasoft.com:4566/queue/eu-central-1/000000000000/myqueue
        * otherwise: http://localhost.shipyard.khulnasoft.com:4566/000000000000/myqueue
        """
        ...
        if config.SQS_ENDPOINT_STRATEGY == "standard":
            ...
            # sqs.us-east-1.localhost.shipyard.khulnasoft.com:4566/000000000000/my-queue
            ...
            # Legacy style
            # queue.localhost.shipyard.khulnasoft.com:4566/000000000000/my-queue (us-east-1)
            # or us-east-2.queue.localhost.shipyard.khulnasoft.com:4566/000000000000/my-queue
...
class StandardQueue(SqsQueue):
    ...
    def receive(
        ...
        while True:
            ...
            # messages in the queue. see https://github.com/khulnasoft/shipyard/issues/5824
            block = False
