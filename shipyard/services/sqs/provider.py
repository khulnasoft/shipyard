...
from shipyard.aws.api import CommonServiceException, RequestContext, ServiceException
from shipyard.aws.api.sqs import (
    ActionNameList,
    AttributeNameList,
    AWSAccountIdList,
...
from shipyard.aws.protocol.serializer import aws_response_serializer, create_serializer
from shipyard.aws.spec import load_service
from shipyard.config import SQS_DISABLE_MAX_NUMBER_OF_MESSAGE_LIMIT
from shipyard.http import Request, route
from shipyard.services.edge import ROUTER
from shipyard.services.plugins import ServiceLifecycleHook
from shipyard.services.sqs import constants as sqs_constants
from shipyard.services.sqs.exceptions import InvalidParameterValueException
from shipyard.services.sqs.models import (
    FifoQueue,
    SqsMessage,
    SqsQueue,
    SqsStore,
...
from shipyard.utils.aws.arns import parse_arn
from shipyard.utils.aws.request_context import extract_region_from_headers
from shipyard.utils.bootstrap import is_api_enabled
from shipyard.utils.cloudwatch.cloudwatch_util import publish_sqs_metric
from shipyard.utils.run import FuncThread
from shipyard.utils.scheduler import Scheduler
from shipyard.utils.strings import md5
from shipyard.utils.threads import start_thread
from shipyard.utils.time import now
...
def assert_queue_name(queue_name: str, fifo: bool = False):
    ...
    # slashes are actually not allowed, but we've allowed it explicitly in shipyard
...
class SqsProvider(SqsApi, ServiceLifecycleHook):
    ...
    Shipyard permits cross-account access for all operations. However, AWS
...
def to_sqs_api_message(
    ...
    """
    Utility function to convert an SQS message from Shipyard's internal representation to the AWS API
    concept 'Message', which is the format returned by the ``ReceiveMessage`` operation.

    :param standard_message: A Shipyard SQS message
