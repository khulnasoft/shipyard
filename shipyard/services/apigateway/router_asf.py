...
from shipyard.constants import HEADER_SHIPYARD_EDGE_URL
...
from shipyard.services.apigateway.helpers import get_api_account_id_and_region
from shipyard.services.apigateway.invocations import invoke_rest_api_from_request
from shipyard.utils.aws.aws_responses import LambdaResponse
from shipyard.utils.strings import remove_leading_extra_slashes
...
def to_invocation_context(
    ...
    # set the x-shipyard-edge header, it is used to parse the domain
    headers[HEADER_SHIPYARD_EDGE_URL] = request.host_url.strip("/")
...
class ApigatewayRouter:
    ...
    def register_routes(self) -> None:
        ...
        # add the shipyard-specific _user_request_ routes
        self.router.add(
