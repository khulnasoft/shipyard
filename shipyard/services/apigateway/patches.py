...
from shipyard.services.apigateway.helpers import TAG_KEY_CUSTOM_ID, apply_json_patch_safe
from shipyard.utils.common import str_to_bool
...
def apply_patches():
    ...
    def create_rest_api(fn, self, *args, tags=None, **kwargs):
        """
        https://github.com/khulnasoft/shipyard/pull/4413/files
