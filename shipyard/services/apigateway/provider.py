...
from shipyard.aws.api import CommonServiceException, RequestContext, ServiceRequest, handler
from shipyard.aws.api.apigateway import (
    Account,
    ApigatewayApi,
    ApiKey,
    ApiKeys,
...
from shipyard.aws.forwarder import NotImplementedAvoidFallbackError, create_aws_request_context
from shipyard.constants import APPLICATION_JSON
from shipyard.services.apigateway.exporter import OpenApiExporter
from shipyard.services.apigateway.helpers import (
    EMPTY_MODEL,
    ERROR_MODEL,
    OpenAPIExt,
...
from shipyard.services.apigateway.invocations import invoke_rest_api_from_request
from shipyard.services.apigateway.models import ApiGatewayStore, RestApiContainer
from shipyard.services.apigateway.patches import apply_patches
from shipyard.services.apigateway.router_asf import ApigatewayRouter, to_invocation_context
from shipyard.services.edge import ROUTER
from shipyard.services.moto import call_moto, call_moto_with_request
from shipyard.services.plugins import ServiceLifecycleHook
from shipyard.utils.collections import (
    DelSafeDict,
    PaginatedList,
    ensure_list,
...
from shipyard.utils.strings import short_uid, str_to_bool, to_bytes, to_str
from shipyard.utils.time import TIMESTAMP_FORMAT_TZ, now_utc, timestamp
...
class ApigatewayProvider(ApigatewayApi, ServiceLifecycleHook):
    ...
    def put_method(
        ...
        if need_authorizer_id and (
            ...
            # TODO: will be cleaner with https://github.com/khulnasoft/shipyard/pull/7750
            raise BadRequestException(
