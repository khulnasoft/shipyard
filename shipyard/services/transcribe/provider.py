...
from shipyard.aws.api.transcribe import (
    BadRequestException,
    ConflictException,
...
from shipyard.services.transcribe.models import TranscribeStore, transcribe_stores
from shipyard.services.transcribe.packages import vosk_package
from shipyard.utils.files import new_tmp_file
...
class TranscribeProvider(TranscribeApi):
    ...
    def download_model(name: str):
        """
        Download a Vosk language model to Shipyard cache directory. Do nothing if model is already downloaded.
