...
from shipyard.aws.api.core import CommonServiceException
from shipyard.aws.api.ses import (
    Address,
    AddressList,
    AmazonResourceName,
...
from shipyard.constants import TEST_AWS_SECRET_ACCESS_KEY
from shipyard.http import Resource, Response
from shipyard.services.moto import call_moto
from shipyard.services.plugins import ServiceLifecycleHook
from shipyard.services.ses.models import SentEmail, SentEmailBody
...
from shipyard.utils.time import timestamp, timestamp_millis
...
# (relative to Shipyard internal HTTP resources base endpoint)
...
class SesServiceApiResource:
    ...
    This is registered as a Shipyard internal HTTP resource.
...
def register_ses_api_resource():
    """Register the email retrospection endpoint as an internal Shipyard endpoint."""
