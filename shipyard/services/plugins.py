...
from shipyard.aws.skeleton import DispatchTable, Skeleton
from shipyard.aws.spec import load_service
from shipyard.config import ServiceProviderConfig
from shipyard.state import StateLifecycleHook, StateVisitable, StateVisitor
from shipyard.utils.bootstrap import get_enabled_apis, is_api_enabled, log_duration
from shipyard.utils.functions import call_safe
from shipyard.utils.sync import SynchronizedDefaultDict, poll_condition

# set up logger
LOG = logging.getLogger(__name__)

# namespace for AWS provider plugins
PLUGIN_NAMESPACE = "shipyard.aws.provider"
...
class Service:
    ...
    def accept_state_visitor(self, visitor: StateVisitor):
        ...
        from shipyard.state.inspect import ReflectionStateLocator
...
def aws_provider(api: str = None, name="default", should_load: Callable[[], bool] = None):
    ...
    decorator are discoverable as a PluginSpec within the namespace "shipyard.aws.provider", with the name
