...
default_log_levels = {
    ...
    "shipyard.aws.accounts": logging.INFO,
    "shipyard.aws.protocol.serializer": logging.INFO,
    "shipyard.aws.serving.wsgi": logging.WARNING,
    "shipyard.request": logging.INFO,
    "shipyard.request.internal": logging.WARNING,
    "shipyard.state.inspect": logging.INFO,
    "shipyard_persistence": logging.INFO,
}

trace_log_levels = {
    "shipyard.aws.protocol.serializer": logging.DEBUG,
    "shipyard.aws.serving.wsgi": logging.DEBUG,
    "shipyard.request": logging.DEBUG,
    "shipyard.request.internal": logging.INFO,
    "shipyard.state.inspect": logging.DEBUG,
}

trace_internal_log_levels = {
    "shipyard.aws.accounts": logging.DEBUG,
    "shipyard.request.internal": logging.DEBUG,
}
...
def setup_logging_for_cli(log_level=logging.INFO):
    ...
    logging.getLogger("shipyard").setLevel(log_level)
...
def setup_logging(log_level=logging.INFO) -> None:
    """
    Configures the python logging environment for Shipyard.
...
def setup_hypercorn_logger(hypercorn_config) -> None:
    """
    Sets the hypercorn loggers, which are created in a peculiar way, to the shipyard settings.
