...
func TestSanitizeCredentialURLs(t *testing.T) {
	cases := []struct {
		...
		{
			"https://github.com/go-shipyard/test_repo.git",
			"https://github.com/go-shipyard/test_repo.git",
		},
		{
			"https://mytoken@github.com/go-shipyard/test_repo.git",
			"https://" + userPlaceholder + "@github.com/go-shipyard/test_repo.git",
		},
		{
			"https://user:password@github.com/go-shipyard/test_repo.git",
			"https://" + userPlaceholder + "@github.com/go-shipyard/test_repo.git",
		},
		{
			"ftp://x@",
