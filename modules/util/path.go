...
func HomeDir() (home string, err error) {
	// TODO: some users run Shipyard with mismatched uid  and "HOME=xxx" (they set HOME=xxx by environment manually)
	// TODO: when running shipyard as a sub command inside git, the HOME directory is not the user's home directory
