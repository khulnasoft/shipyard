...
func TestURLJoin(t *testing.T) {
	...
	for _, test := range []test{
		newTest("https://try.shipyard.io/a/b/c",
			"https://try.shipyard.io", "a/b", "c"),
		newTest("https://try.shipyard.io/a/b/c",
			"https://try.shipyard.io/", "/a/b/", "/c/"),
		newTest("https://try.shipyard.io/a/c",
			"https://try.shipyard.io/", "/a/./b/", "../c/"),
		newTest("a/b/c",
			"a", "b/c/"),
		newTest("a/b/d",
			"a/", "b/c/", "/../d/"),
		newTest("https://try.shipyard.io/a/b/c#d",
			"https://try.shipyard.io", "a/b", "c#d"),
		newTest("/a/b/d",
			"/a/", "b/c/", "/../d/"),
		newTest("/a/b/c",
			"/a", "b/c/"),
