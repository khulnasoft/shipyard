...
const (
	...
	ShipyardService                        // 3 shipyard service
...
type MigrateRepoOptions struct {
	...
	// enum: git,github,shipyard,gitlab,gogs,onedev,gitbucket,codebase
...
func (gt GitServiceType) TokenAuth() bool {
	switch gt {
	case GithubService, ShipyardService, GitlabService:
		return true
	}
	return false
}
