...
7ae1K28QbMMcqI8CqwIrgwg9nTOp8Oj9q81plUY7ZuwXN8Vvs8wbAAA=`
	...
	assert.Equal(t, "shipyard-test", p.Name)
	...
	assert.Equal(t, "https://shipyard.io", p.VersionMetadata.ProjectURL)
	...
	assert.Equal(t, "shipyard-test-1.0.2-1.src.rpm", p.FileMetadata.SourceRpm)
	...
	assert.ElementsMatch(
		...
		[]*Changelog{
			{
				Author: "KN4CK3R <dummy@shipyard.io>",
				Date:   1678276800,
