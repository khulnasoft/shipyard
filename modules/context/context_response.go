...
func (ctx *Context) HTML(status int, name base.TplName) {
	...
	if name != tplStatus500 {
		...
		ctx.PlainText(http.StatusInternalServerError, "Unable to render status/500 page, the template system is broken, or Shipyard can't find your template files.")
		return
	}
}
