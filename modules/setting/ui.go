...
var UI = struct {
	...
	DefaultTheme:            `shipyard-auto`,
	Themes:                  []string{`shipyard-auto`, `shipyard-light`, `shipyard-dark`},
	Reactions:               []string{`+1`, `-1`, `laugh`, `hooray`, `confused`, `heart`, `rocket`, `eyes`},
	CustomEmojis:            []string{`git`, `shipyard`, `codeberg`, `gitlab`, `github`, `gogs`},
	CustomEmojisMap:         map[string]string{"git": ":git:", "shipyard": ":shipyard:", "codeberg": ":codeberg:", "gitlab": ":gitlab:", "github": ":github:", "gogs": ":gogs:"},
	...
	Meta: struct {
		...
		Author:      "Shipyard - Git with a cup of tea",
		Description: "Shipyard (Git with a cup of tea) is a painless self-hosted Git service written in Go",
		Keywords:    "go,git,self-hosted,shipyard",
	},
}
