...
var (
	...
	AppURL string
	// AppSubURL represents the sub-url mounting point for shipyard. It is either "" or starts with '/' and ends without '/', such as '/{subpath}'.
	// This value is empty if site does not have sub-url.
	AppSubURL string
	// AppDataPath is the default path for storing data.
	// It maps to ini:"APP_DATA_PATH" in [server] and defaults to AppWorkPath + "/data"
	AppDataPath string
	// LocalURL is the url for locally running applications to contact Shipyard. It always has a '/' suffix
...
func loadServerFrom(rootCfg ConfigProvider) {
	...
	AppName = rootCfg.Section("").Key("APP_NAME").MustString("Shipyard: Git with a cup of tea")
