...
`
	...
	assert.EqualValues(t, "minio", Attachment.Storage.Type)
	assert.EqualValues(t, "shipyard-minio", Attachment.Storage.MinioConfig.Bucket)
	assert.EqualValues(t, "attachments/", Attachment.Storage.MinioConfig.BasePath)
}
...
`
	...
	assert.EqualValues(t, "shipyard", storage.MinioConfig.Bucket)
}
...
`
	...
	assert.NoError(t, loadAttachmentFrom(cfg))
	assert.EqualValues(t, "minio", Attachment.Storage.Type)
	assert.EqualValues(t, "shipyard", Attachment.Storage.MinioConfig.Bucket)
	assert.EqualValues(t, "attachments/", Attachment.Storage.MinioConfig.BasePath)
}
