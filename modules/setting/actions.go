...
const (
	...
	defaultActionsURLSelf   = "self"   // the root URL of the self-hosted Shipyard instance
	// DefaultActionsURL only supports GitHub and the self-hosted Shipyard.
	// It's intentionally not supported more, so please be cautious before adding more like "shipyard" or "gitlab".
