...
func TestInitWorkPathAndCommonConfig(t *testing.T) {
	...
	t.Run("WorkDir(env)", func(t *testing.T) {
		testInit(dirFoo, "", "")
		InitWorkPathAndCommonConfig(envVars{"SHIPYARD_WORK_DIR": dirBar}.Getenv, ArgWorkPathAndCustomConf{})
	...
	t.Run("WorkDir(env,arg)", func(t *testing.T) {
		testInit(dirFoo, "", "")
		InitWorkPathAndCommonConfig(envVars{"SHIPYARD_WORK_DIR": dirBar}.Getenv, ArgWorkPathAndCustomConf{WorkPath: dirXxx})
	...
	t.Run("CustomPath(env)", func(t *testing.T) {
		testInit(dirFoo, "", "")
		InitWorkPathAndCommonConfig(envVars{"SHIPYARD_CUSTOM": fp(dirBar, "custom1")}.Getenv, ArgWorkPathAndCustomConf{})
		assert.Equal(t, dirFoo, AppWorkPath)
	...
	t.Run("CustomPath(env,arg)", func(t *testing.T) {
		testInit(dirFoo, "", "")
		InitWorkPathAndCommonConfig(envVars{"SHIPYARD_CUSTOM": fp(dirBar, "custom1")}.Getenv, ArgWorkPathAndCustomConf{CustomPath: "custom2"})
		assert.Equal(t, dirFoo, AppWorkPath)
	...
	t.Run("CustomConfOverrideWorkPath", func(t *testing.T) {
		...
		testInit(dirFoo, "", "")
		InitWorkPathAndCommonConfig(envVars{"SHIPYARD_WORK_DIR": dirBar}.Getenv, ArgWorkPathAndCustomConf{CustomConf: iniWorkPath})
		assert.Equal(t, dirXxx, AppWorkPath)
		assert.Equal(t, fp(dirXxx, "custom"), CustomPath)
		assert.Equal(t, iniWorkPath, CustomConf)
	...
	t.Run("Builtin", func(t *testing.T) {
		...
		testInit(dirFoo, "custom1", "cfg.ini")
		InitWorkPathAndCommonConfig(envVars{"SHIPYARD_WORK_DIR": dirYyy}.Getenv, ArgWorkPathAndCustomConf{})
		...
		testInit(dirFoo, "custom1", "cfg.ini")
		InitWorkPathAndCommonConfig(envVars{"SHIPYARD_CUSTOM": dirYyy}.Getenv, ArgWorkPathAndCustomConf{})
		assert.Equal(t, dirFoo, AppWorkPath)
