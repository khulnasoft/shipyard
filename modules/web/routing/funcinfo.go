...
// shortenFilename generates a short source code filename from a full package path, eg: "code.shipyard.io/routers/common/logger_context.go" => "common/logger_context.go"
