...
import (
	...
	"github.com/khulnasoft/shipyard/modules/markup/markdown/math"
...
// SpecializedMarkdown sets up the Shipyard specific markdown extensions
...
func actualRender(ctx *markup.RenderContext, input io.Reader, output io.Writer) error {
	...
	buf = shipyardutil.NormalizeEOL(buf)
