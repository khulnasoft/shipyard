...
var KindFootnoteLink = ast.NewNodeKind("ShipyardFootnoteLink")
...
var KindFootnoteBackLink = ast.NewNodeKind("ShipyardFootnoteBackLink")
...
var KindFootnote = ast.NewNodeKind("ShipyardFootnote")
...
var KindFootnoteList = ast.NewNodeKind("ShipyardFootnoteList")
...
// FootnoteExtension represents the Shipyard Footnote
var FootnoteExtension = &footnoteExtension{}

// Extend extends the markdown converter with the Shipyard Footnote parser
