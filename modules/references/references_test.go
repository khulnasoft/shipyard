...
func TestConvertFullHTMLReferencesToShortRefs(t *testing.T) {
	re := regexp.MustCompile(`(\s|^|\(|\[)` +
		regexp.QuoteMeta("https://ourshipyard.khulnasoft.com/git/") +
		`([0-9a-zA-Z-_\.]+/[0-9a-zA-Z-_\.]+)/` +
		`((?:issues)|(?:pulls))/([0-9]+)(?:\s|$|\)|\]|[:;,.?!]\s|[:;,.?!]$)`)
	test := `this is a https://ourshipyard.khulnasoft.com/git/owner/repo/issues/123456789, foo
https://ourshipyard.khulnasoft.com/git/owner/repo/pulls/123456789
  And https://ourshipyard.khulnasoft.com/git/owner/repo/pulls/123
`
...
func TestFindAllIssueReferences(t *testing.T) {
	fixtures := []testFixture{
		...
		{
			"This [four](http://shipyard.khulnasoft.com:3000/org3/repo4/issues/203) yes.",
			[]testResult{
		...
		{
			"This http://shipyard.khulnasoft.com:3000/user4/repo5/201 no, bad URL.",
			[]testResult{},
		},
		{
			"This http://shipyard.khulnasoft.com:3000/user4/repo5/pulls/202 yes.",
			[]testResult{
				{202, "user4", "repo5", "202", true, XRefActionNone, nil, nil, ""},
			},
		},
		{
			"This http://shipyard.khulnasoft.com:3000/user4/repo5/pulls/202 yes. http://shipyard.khulnasoft.com:3000/user4/repo5/pulls/203 no",
			[]testResult{
				{202, "user4", "repo5", "202", true, XRefActionNone, nil, nil, ""},
		...
		{
			"This http://ShipYarD.COM:3000/user4/repo6/pulls/205 yes.",
			[]testResult{
...
func testFixtures(t *testing.T, fixtures []testFixture, context string) {
	...
	setting.AppURL = "https://shipyard.khulnasoft.com:3000/"
...
func TestFindRenderizableCommitCrossReference(t *testing.T) {
	cases := []struct {
		...
		{
			Input:    "go-shipyard/shipyard@test",
			Expected: nil,
		},
		{
			Input:    "go-shipyard/shipyard@ab1234",
			Expected: nil,
		},
		{
			Input: "go-shipyard/shipyard@abcd1234",
			Expected: &RenderizableReference{
				Owner:       "go-shipyard",
				Name:        "shipyard",
				CommitSha:   "abcd1234",
		...
		{
			Input: "go-shipyard/shipyard@abcd1234abcd1234abcd1234abcd1234abcd1234",
			Expected: &RenderizableReference{
				Owner:       "go-shipyard",
				Name:        "shipyard",
		...
		{
			Input:    "go-shipyard/shipyard@abcd1234abcd1234abcd1234abcd1234abcd12340", // longer than 40 characters
			Expected: nil,
		},
		{
			Input: "test go-shipyard/shipyard@abcd1234 test",
			Expected: &RenderizableReference{
				Owner:       "go-shipyard",
				Name:        "shipyard",
				CommitSha:   "abcd1234",
