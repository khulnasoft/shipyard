...
// ShipyardUpdateChecker returns error when new version of Shipyard is available
func ShipyardUpdateChecker(httpEndpoint string) error {
...
// UpdateRemoteVersion updates the latest available version of Shipyard
...
// GetNeedUpdate returns true whether a newer version of Shipyard is available
