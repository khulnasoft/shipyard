...
func TestSetupShipyardRoot(t *testing.T) {
	_ = os.Setenv("SHIPYARD_ROOT", "test")
	assert.Equal(t, "test", SetupShipyardRoot())
	_ = os.Setenv("SHIPYARD_ROOT", "")
	assert.NotEqual(t, "test", SetupShipyardRoot())
}
