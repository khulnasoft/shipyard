...
import (
	...
	"github.com/khulnasoft/shipyard/models/avatars"
	...
	shipyard_html "github.com/khulnasoft/shipyard/modules/html"
...
func (au *AvatarUtils) Avatar(item any, others ...any) template.HTML {
	size, class := shipyard_html.ParseSizeAndClass(avatars.DefaultAvatarPixelSize, avatars.DefaultAvatarClass, others...)
