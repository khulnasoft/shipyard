...
import (
	...
	"github.com/khulnasoft/shipyard/modules/templates/eval"
...
func NewFuncMap() template.FuncMap {
	return map[string]any{
		...
		"AppUrl": func() string {
			...
			// And it's difficult for Shipyard to guess absolute URL correctly with zero configuration,
			// because Shipyard doesn't know whether the scheme is HTTP or HTTPS unless the reverse proxy could tell Shipyard.
