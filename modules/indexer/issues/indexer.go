...
import (
	...
	db_model "github.com/khulnasoft/shipyard/models/db"
	repo_model "github.com/khulnasoft/shipyard/models/repo"
	"github.com/khulnasoft/shipyard/modules/graceful"
	"github.com/khulnasoft/shipyard/modules/indexer/issues/bleve"
	"github.com/khulnasoft/shipyard/modules/indexer/issues/db"
	"github.com/khulnasoft/shipyard/modules/indexer/issues/elasticsearch"
	"github.com/khulnasoft/shipyard/modules/indexer/issues/internal"
	"github.com/khulnasoft/shipyard/modules/indexer/issues/meilisearch"
		...
		case "bleve":
			defer func() {
				if err := recover(); err != nil {
					...
					log.Error("You can completely remove the %q directory to make Shipyard recreate the indexes", setting.Indexer.IssuePath)
					globalIndexer.Store(dummyIndexer)
