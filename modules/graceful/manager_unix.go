...
import (
	...
	"github.com/khulnasoft/shipyard/modules/graceful/releasereopen"
...
func (g *Manager) start() {
	...
	g.notify(statusMsg("Starting Shipyard"))
	g.notify(pidMsg())
...
func (g *Manager) DoGracefulRestart() {
	if setting.GracefulRestartable {
		...
		// doFork calls RestartProcess which starts a new Shipyard process, so this parent process needs to exit
