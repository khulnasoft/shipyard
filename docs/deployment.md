...
If you want to skip the fuss, and [get straight down to it](/docs/quick-start), then you can spin up a new instance of Shipyard by running:
...
Once you've got Shipyard up and running, you'll want to configure it with your own content, for this you can reference the [configuring docs](/docs/configuring).
...
The image defaults to `:latest`, but you can instead specify a specific version, e.g. `docker pull khulnasoft/shipyard:release-1.5.0`
...
To deploy Shipyard to Platform.sh, use the following link
