...
Beyond the cloud backup/restore service, there are several other self-hosted options you can use to backup Shipyard, and any other Docker container data. These are outlined in the Management docs, at: [Docker Backup Options](/docs/management#backing-up).
...
- For the code used for Shipyard's cloud service, see [here](https://gist.github.com/khulnasoft/d19b43d50f30e02fa25f349cf5cb5ed8#file-index-js)
