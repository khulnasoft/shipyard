...
```
PUT https://shipyard.example.com/api/packages/{owner}/generic/{package_name}/{package_version}/{file_name}
```
...
curl --user your_username:your_password_or_token \
     ...
     https://shipyard.example.com/api/packages/testuser/generic/test_package/1.0.0/file.bin
```
...
```
GET https://shipyard.example.com/api/packages/{owner}/generic/{package_name}/{package_version}/{file_name}
```
...
```
DELETE https://shipyard.example.com/api/packages/{owner}/generic/{package_name}/{package_version}
```
...
curl --user your_username:your_token_or_password -X DELETE \
     https://shipyard.example.com/api/packages/testuser/generic/test_package/1.0.0
```
...
```
DELETE https://shipyard.example.com/api/packages/{owner}/generic/{package_name}/{package_version}/{filename}
```
