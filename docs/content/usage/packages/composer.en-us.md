...
```
PUT https://shipyard.example.com/api/packages/{owner}/composer
```
...
```
PUT https://shipyard.example.com/api/packages/{owner}/composer?version={x.y.z}
```
...
curl --user your_username:your_password_or_token \
     ...
     https://shipyard.example.com/api/packages/testuser/composer
```
...
curl --user your_username:your_password_or_token \
     --upload-file path/to/project.zip \
     https://shipyard.example.com/api/packages/testuser/composer?version=1.0.3
```
...
```json
{
  "repositories": [{
      "type": "composer",
      "url": "https://shipyard.example.com/api/packages/{owner}/composer"
   }
  ]
}
```
