...
```shell
dnf config-manager --add-repo https://shipyard.example.com/api/packages/{owner}/rpm.repo
```
...
```shell
dnf config-manager --add-repo https://{username}:{your_password_or_token}@shipyard.example.com/api/packages/{owner}/rpm.repo
```
...
```
PUT https://shipyard.example.com/api/packages/{owner}/rpm/upload
```
...
curl --user your_username:your_password_or_token \
     ...
     https://shipyard.example.com/api/packages/testuser/rpm/upload
```
...
```
DELETE https://shipyard.example.com/api/packages/{owner}/rpm/{package_name}/{package_version}/{architecture}
```
...
curl --user your_username:your_token_or_password -X DELETE \
     https://shipyard.example.com/api/packages/testuser/rpm/test-package/1.0.0/x86_64
```
