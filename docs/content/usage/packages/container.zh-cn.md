...
```shell
docker login shipyard.example.com
```
...
`shipyard.example.com/testuser/myimage`

`shipyard.example.com/testuser/my-image`
...
```shell
docker push shipyard.example.com/{owner}/{image}:{tag}
```
...
```shell
docker push shipyard.example.com/testuser/myimage:latest
```
...
```shell
docker pull shipyard.example.com/{owner}/{image}:{tag}
```
...
```shell
docker pull shipyard.example.com/testuser/myimage:latest
```
