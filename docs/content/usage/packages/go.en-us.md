...
```
PUT https://shipyard.example.com/api/packages/{owner}/go/upload
```
...
curl --user your_username:your_password_or_token \
     ...
     https://shipyard.example.com/api/packages/testuser/go/upload
```
...
```shell
# use latest version
GOPROXY=https://shipyard.example.com/api/packages/{owner}/go go install {package_name}
# or
GOPROXY=https://shipyard.example.com/api/packages/{owner}/go go install {package_name}@latest
# use specific version
GOPROXY=https://shipyard.example.com/api/packages/{owner}/go go install {package_name}@{package_version}
```
