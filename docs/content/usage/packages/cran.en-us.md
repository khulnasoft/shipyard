...
```
options("repos" = c(getOption("repos"), c(shipyard="https://shipyard.example.com/api/packages/{owner}/cran")))
```
...
If you need to provide credentials, you may embed them as part of the url (`https://user:password@shipyard.example.com/...`).
...
```
PUT https://shipyard.example.com/api/packages/{owner}/cran/src
```
...
```
PUT https://shipyard.example.com/api/packages/{owner}/cran/bin?platform={platform}&rversion={rversion}
```
...
curl --user your_username:your_password_or_token \
     ...
     https://shipyard.example.com/api/packages/testuser/cran/bin?platform=windows&rversion=4.2
```
