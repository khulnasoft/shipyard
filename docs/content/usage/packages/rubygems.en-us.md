...
```ini
---
https://shipyard.example.com/api/packages/{owner}/rubygems: Bearer {token}
```
...
```
---
https://shipyard.example.com/api/packages/testuser/rubygems: Bearer 3bd626f84b01cd26b873931eace1e430a5773cc4
```
...
```shell
gem push --host https://shipyard.example.com/api/packages/testuser/rubygems test_package-1.0.0.gem
```
...
```
source "https://shipyard.example.com/api/packages/{owner}/rubygems" do
  gem "{package_name}"
end
```
...
```
source "https://shipyard.example.com/api/packages/testuser/rubygems" do
  gem "test_package"
end
```
...
```shell
gem install --host https://shipyard.example.com/api/packages/{owner}/rubygems {package_name}
```
...
```shell
gem install --host https://shipyard.example.com/api/packages/testuser/rubygems test_package
```
