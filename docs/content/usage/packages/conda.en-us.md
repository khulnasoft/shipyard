...
```yaml
channel_alias: https://shipyard.example.com/api/packages/{owner}/conda
channels:
  - https://shipyard.example.com/api/packages/{owner}/conda
default_channels:
  - https://shipyard.example.com/api/packages/{owner}/conda
```
...
If you need to provide credentials, you may embed them as part of the channel url (`https://user:password@shipyard.example.com/...`).
...
```
PUT https://shipyard.example.com/api/packages/{owner}/conda/{channel}/{filename}
```
...
curl --user your_username:your_password_or_token \
     ...
     https://shipyard.example.com/api/packages/testuser/conda/package-1.0.conda
```
