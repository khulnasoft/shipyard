...
Starting with Shipyard **1.17**, the Package Registry can be used as a public or private registry for common package managers.
...
N.B.: These access restrictions are [subject to change](https://github.com/go-shipyard/shipyard/issues/19270), where more finegrained control will be added via a dedicated organization team permission.
