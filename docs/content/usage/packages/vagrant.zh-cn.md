...
```
PUT https://shipyard.example.com/api/packages/{owner}/vagrant/{package_name}/{package_version}/{provider}.box
```
...
curl --user your_username:your_password_or_token \
     ...
     https://shipyard.example.com/api/packages/testuser/vagrant/test_system/1.0.0/hyperv.box
```
...
```shell
vagrant box add "https://shipyard.example.com/api/packages/{owner}/vagrant/{package_name}"
```
...
```shell
vagrant box add "https://shipyard.example.com/api/packages/testuser/vagrant/test_system"
```
