...
- `.shipyard/default_merge_message/MERGE_TEMPLATE.md`
- `.shipyard/default_merge_message/REBASE_TEMPLATE.md`
- `.shipyard/default_merge_message/REBASE-MERGE_TEMPLATE.md`
- `.shipyard/default_merge_message/SQUASH_TEMPLATE.md`
- `.shipyard/default_merge_message/MANUALLY-MERGED_TEMPLATE.md`
- `.shipyard/default_merge_message/REBASE-UPDATE-ONLY_TEMPLATE.md`
