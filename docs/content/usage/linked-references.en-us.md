...
Alternatively, the `!1234` notation can be used as well. Even when in Shipyard
a pull request is a form of issue, the `#1234` form will always link to
an issue; if the linked entry happens to be a pull request instead, Shipyard
...
in a particular issue. Shipyard supports closing and reopening the referenced
...
Shipyard supports the use of external issue trackers, and references to issues
...
the pull requests hosted in Shipyard. To address this, Shipyard allows the use of
the `!` marker to identify pull requests. For example:

> This is issue [#1234](#), and links to the external tracker.
> This is pull request [!1234](#), and links to a pull request in Shipyard.
