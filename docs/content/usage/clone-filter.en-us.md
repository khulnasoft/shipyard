...
This requires Git version 2.22 or later, both on the Shipyard server and on the
...
Shipyard server as admin and head to Site Administration -> Configuration to
