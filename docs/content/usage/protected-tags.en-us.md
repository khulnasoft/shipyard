...
| Glob  | `shipyard`                  | only `shipyard`                            |
| Glob  | `*shipyard*`                | `shipyard`, `2.1-shipyard`, `1_shipyard-release` |
...
| Regex | `/shipyard/`                | `shipyard`, `2.1-shipyard`, `1_shipyard-release` |
| Regex | `/\Ashipyard\z/`            | only `shipyard`                            |
| Regex | `/^shipyard$/`              | only `shipyard`                            |
