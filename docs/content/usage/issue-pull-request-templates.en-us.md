...
when creating an issue or pull request. Shipyard supports adding templates to the
...
- `issue_template.yaml`
- `issue_template.yml`
- `.shipyard/ISSUE_TEMPLATE.md`
- `.shipyard/ISSUE_TEMPLATE.yaml`
- `.shipyard/ISSUE_TEMPLATE.yml`
- `.shipyard/issue_template.md`
- `.shipyard/issue_template.yaml`
- `.shipyard/issue_template.yml`
...
- `.shipyard/ISSUE_TEMPLATE/config.yaml`
- `.shipyard/ISSUE_TEMPLATE/config.yml`
- `.shipyard/issue_template/config.yaml`
- `.shipyard/issue_template/config.yml`
...
- `pull_request_template.yaml`
- `pull_request_template.yml`
- `.shipyard/PULL_REQUEST_TEMPLATE.md`
- `.shipyard/PULL_REQUEST_TEMPLATE.yaml`
- `.shipyard/PULL_REQUEST_TEMPLATE.yml`
- `.shipyard/pull_request_template.md`
- `.shipyard/pull_request_template.yaml`
- `.shipyard/pull_request_template.yml`
...
| render      | If a value is provided, submitted text will be formatted into a codeblock. When this key is provided, the text area will not expand for file attachments or Markdown editing. | Optional | String | -            | Languages known to Shipyard. |
...
contact_links:
  - name: Shipyard
    ...
    about: Visit the Shipyard Website
```
