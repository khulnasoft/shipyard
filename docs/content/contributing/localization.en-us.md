...
Shipyard's localization happens through our [Crowdin project](https://crowdin.com/project/shipyard).

For changes to an **English** translation, a pull request can be made that changes the appropriate key in
the [english locale](https://github.com/go-shipyard/shipyard/blob/main/options/locale/locale_en-US.ini).
...
At the time of writing, this means that a changed translation may not appear until the following Shipyard release.
