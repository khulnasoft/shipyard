...
Since the first line of code was written at Feb 12, 2014, Shipyard has grown to be a large project.
...
To make the codebase more maintainable and make Shipyard better, developers should keep in mind to use modern mechanisms to refactor the old code.
