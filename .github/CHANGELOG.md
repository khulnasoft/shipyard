...
## ✨ 2.1.1 Improvements [PR #775](https://github.com/khulnaSoft/shipyard/pull/775)
...
## ✨ 2.0.9 Adds Multi-Page Support [PR #685](https://github.com/khulnaSoft/shipyard/pull/685)
- Adds Widgets for AdGuard

## ✨ 2.0.9 Adds Multi-Page Support [PR #663](https://github.com/khulnaSoft/shipyard/pull/663)
...
## ✨ 1.9.8 - More Widgets and Widget Improvements [PR #425](https://github.com/khulnaSoft/shipyard/pull/425)
...
## 🐛 1.9.7 - Minor UI Editor Bug fixes [PR #416](https://github.com/khulnaSoft/shipyard/pull/416)
- Fixes unable to edit item bug (#415)
- Fixes unable to add new app bug (#390)
- Fixes nav links visibility (#389)

## ⚡️ 1.9.6 - Adds Proxy Support for Widget Requests [PR #392](https://github.com/khulnaSoft/shipyard/pull/392)
...
## 🐛 1.9.5 - Bug fixes and Minor Improvements [PR #388](https://github.com/khulnaSoft/shipyard/pull/388)
- Adds icon.horse to supported favicon APIs
- Fixes tile move bug, Re: #366
- Fixes save items without title bug, Re: #377

## ✨ 1.9.4 - Widget Support [PR #382](https://github.com/khulnaSoft/shipyard/pull/382)
...
## ⚡️ 1.9.2 - Native SSL Support + Performance Improvements [PR #326](https://github.com/khulnaSoft/shipyard/pull/326)
...
## 💄 1.9.1 - Editor and Theming Fixes and Improvements [PR #319](https://github.com/khulnaSoft/shipyard/pull/319)
...
## 🐳 1.9.0 - Alpha of Shipyard-Lite Docker Container [PR #306](https://github.com/khulnaSoft/shipyard/pull/306)
...
## ✨ 1.8.9 - All New Interactive Config Editor [PR #298](https://github.com/khulnaSoft/shipyard/pull/298)
...
## ⚡️ 1.6.8 - Improved Loading Experience [PR #183](https://github.com/khulnaSoft/shipyard/pull/183)
...
## ⚡️ 1.6.7 - Option for non-SSL status checks plus minor things [PR #182](https://github.com/khulnaSoft/shipyard/pull/182)
...
## ⚡️ 1.6.6 - Improved Search & Shortcuts [PR #175](https://github.com/khulnaSoft/shipyard/pull/175)
...
## ✨ 1.6.5 - Adds support for Secure Authentication using Keycloak [PR #174](https://github.com/khulnaSoft/shipyard/pull/174)
- Major restructure of auth config
- Implements keycloak support, adds docs and updates schema

## ✨ 1.6.4 - Adds functionality for Granular Auth Control [PR #171](https://github.com/khulnaSoft/shipyard/pull/171)
...
## ⚡️ 1.6.3 - Dependency and Build File Updates [PR #168](https://github.com/khulnaSoft/shipyard/pull/168)
...
## ✨ 1.6.2 - Support for Guest Access [PR #167](https://github.com/khulnaSoft/shipyard/pull/167)
...
## 💄 1.6.1 - Adds new Theme [PR #166](https://github.com/khulnaSoft/shipyard/issues/166)
- Adds Shipyard theme, for use in the dev dashboard

## ✨ 1.5.9 - New Minimal/ Startpage View [PR #155](https://github.com/khulnaSoft/shipyard/issues/155)
...
## ✨ 1.5.8 - Multi-Tasking Support in Workspace View [PR #146](https://github.com/khulnaSoft/shipyard/pull/146)
...
## 🔨 1.3.9 - Enable Custom Styesheet in Docker [PR #92](https://github.com/khulnaSoft/shipyard/pull/92)
- Enables the user to pass a custom stylesheet in with Docker
- Adds support for 1-Click deployment to Render.com

## 🌟 1.3.8 - Showcase [#91](https://github.com/khulnaSoft/shipyard/pull/91)
- Adds @Shadowking001's screenshot to showcase

## 🌟 1.3.7 - Showcase [PR #84](https://github.com/khulnaSoft/shipyard/pull/84)
- Adds @dtctek's screenshot to showcase

## ✨ 1.3.6 - Enables User to Hide Unwanted Components [PR #78](https://github.com/khulnaSoft/shipyard/pull/78)
...
## ✨ 1.3.5 - Adds Support for Emoji Icons [PR #76](https://github.com/khulnaSoft/shipyard/pull/76)
- Enables user to use emojis for item and section icons
- Adds a handler to convert Unicode, or Shortcode into an Emoji

## 🌟 1.3.4 - Showcase Addition [PR #75](https://github.com/khulnaSoft/shipyard/pull/75)
- Adds @cerealconyogurt's screenshot to the showcase

## 💄 1.3.3 - UI Improvements [PR #73](https://github.com/khulnaSoft/shipyard/pull/73)
...
## ⚡️ 1.3.0 - Custom Headers for Status Check [PR #72](https://github.com/khulnaSoft/shipyard/pull/72)
...
## 🌟 1.2.9 - Creates a Showcase Page [PR #68](https://github.com/khulnaSoft/shipyard/pull/68)
- Adds a page in the docs for users to share their screenshots of their dashboard

## ✨ 1.2.8 - Adds Remember-Me Functionality into the Login Form [PR #66](https://github.com/khulnaSoft/shipyard/pull/66)
...
## ✨ 1.2.7 - Implements a Right-Click Context Menu [#62](https://github.com/khulnaSoft/shipyard/pull/62)
...
## ⚡️ 1.2.6 - Make Font Assets Local [PR #60](https://github.com/khulnaSoft/shipyard/pull/60)
- Downloaded font files to assets
- Removed all calls to font CDN, replaced with local calls

## 🐛 1.2.5 - Small Fixes, and Efficiency Improvements [PR #57](https://github.com/khulnaSoft/shipyard/pull/57)
...
## ✨ 1.2.4 - Adds Support for Continuous Status Checking [#52](https://github.com/khulnaSoft/shipyard/pull/52)
...
## 🐛 1.2.3 - Bug Fix [PR #49](https://github.com/khulnaSoft/shipyard/pull/49)
...
## 🐛 1.2.1 - Bugfix [#44](https://github.com/khulnaSoft/shipyard/pull/44)
- Fixes footer positioning on mobile, makes sticky, fixes #42

## ✨ 1.2.0 - Adds Writing Config to Disk from UI Functionality [PR #43](https://github.com/khulnaSoft/shipyard/pull/43)
...
## 🐛 1.1.8 - Bugfix [#40](https://github.com/khulnaSoft/shipyard/pull/40)
...
## ✨ 0.7.0 - Support for Custom Nav Links [PR #4](https://github.com/khulnaSoft/shipyard/pull/4)
...
## ✨ 0.6.5 - UI Config Editor [PR #3](https://github.com/khulnaSoft/shipyard/pull/3)
...
## 🎉 0.1.0 - Init
Project started. Forked from [KhulnaSoft-bot/Dash](https://github.com/KhulnaSoft-bot/dash)
