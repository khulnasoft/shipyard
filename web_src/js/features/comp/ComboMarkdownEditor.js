...
class ComboMarkdownEditor {
  constructor(container, options = {}) {
    container._shipyardComboMarkdownEditor = this;
  ...
  setupTextarea() {
    ...
    this.textarea._shipyardComboMarkdownEditor = this;
  ...
  prepareEasyMDEToolbarActions() {
    this.easyMDEToolbarDefault = [
      ...
      'heading-bigger', 'heading-smaller', '|', 'code', 'quote', '|', 'shipyard-checkbox-empty',
      'shipyard-checkbox-checked', '|', 'unordered-list', 'ordered-list', '|', 'link', 'image',
      'table', 'horizontal-rule', '|', 'shipyard-switch-to-textarea',
    ];
  }
...
export function getComboMarkdownEditor(el) {
  ...
  return el?._shipyardComboMarkdownEditor;
}
