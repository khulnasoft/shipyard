...
export function initGlobalButtons() {
  ...
  // However, Shipyard misuses the modal dialog and put the cancel buttons inside forms, so we must prevent the form submission.
...
export function checkAppUrl() {
  ...
  // some users visit "https://domain/shipyard" while appUrl is "https://domain/shipyard/", there should be no warning
