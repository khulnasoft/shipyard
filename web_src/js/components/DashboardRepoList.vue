...
const commitStatus = {
  ...
  error: {name: 'shipyard-exclamation', color: 'red'},
  failure: {name: 'octicon-x', color: 'red'},
  warning: {name: 'shipyard-exclamation', color: 'yellow'},
};
      ...
      <div v-if="repos.length" class="ui attached table segment gt-rounded-bottom">
        ...
        <div v-if="showMoreReposLink" class="center gt-py-3 gt-border-secondary-top">
          <div class="ui borderless pagination menu narrow">
            ...
            >
              <svg-icon name="shipyard-double-chevron-left" :size="16" class-name="gt-mr-2"/>
            </a>
            <a
              class="item navigation gt-py-2" :class="{'disabled': page === 1}"
            ...
            >
              <svg-icon name="shipyard-double-chevron-right" :size="16" class-name="gt-ml-2"/>
            </a>
          </div>
        </div>
      </div>
