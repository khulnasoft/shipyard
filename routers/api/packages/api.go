...
import (
	...
	"github.com/khulnasoft/shipyard/routers/api/packages/alpine"
	"github.com/khulnasoft/shipyard/routers/api/packages/cargo"
	"github.com/khulnasoft/shipyard/routers/api/packages/chef"
	"github.com/khulnasoft/shipyard/routers/api/packages/composer"
	"github.com/khulnasoft/shipyard/routers/api/packages/conan"
	"github.com/khulnasoft/shipyard/routers/api/packages/conda"
	"github.com/khulnasoft/shipyard/routers/api/packages/container"
	"github.com/khulnasoft/shipyard/routers/api/packages/cran"
	"github.com/khulnasoft/shipyard/routers/api/packages/debian"
	"github.com/khulnasoft/shipyard/routers/api/packages/generic"
	"github.com/khulnasoft/shipyard/routers/api/packages/goproxy"
	"github.com/khulnasoft/shipyard/routers/api/packages/helm"
	"github.com/khulnasoft/shipyard/routers/api/packages/maven"
	"github.com/khulnasoft/shipyard/routers/api/packages/npm"
	"github.com/khulnasoft/shipyard/routers/api/packages/nuget"
	"github.com/khulnasoft/shipyard/routers/api/packages/pub"
	"github.com/khulnasoft/shipyard/routers/api/packages/pypi"
	"github.com/khulnasoft/shipyard/routers/api/packages/rpm"
	"github.com/khulnasoft/shipyard/routers/api/packages/rubygems"
	"github.com/khulnasoft/shipyard/routers/api/packages/swift"
	"github.com/khulnasoft/shipyard/routers/api/packages/vagrant"
	...
	return func(ctx *context.Context) {
		if ctx.Data["IsApiToken"] == true {
			...
			if ok { // it's a personal access token but not oauth2 token
				...
				if !scopeMatched {
					ctx.Resp.Header().Set("WWW-Authenticate", `Basic realm="Shipyard Package API"`)
