...
import (
	...
	actions_module "github.com/khulnasoft/shipyard/modules/actions"
	...
	"github.com/khulnasoft/shipyard/services/actions"
...
func getSecretsOfTask(ctx context.Context, task *actions_model.ActionTask) map[string]string {
	...
	secrets["SHIPYARD_TOKEN"] = task.Token

	if task.Job.Run.IsForkPullRequest && task.Job.Run.TriggerEvent != actions_module.GithubEventPullRequestTarget {
		// ignore secrets for fork pull request, except GITHUB_TOKEN and SHIPYARD_TOKEN which are automatically generated.
...
func generateTaskContext(t *actions_model.ActionTask) *structpb.Struct {
	...
	// TriggerEvent is added in https://github.com/go-shipyard/shipyard/pull/25229
	...
	taskContext, err := structpb.NewStruct(map[string]any{
		...
		// additional contexts
		"shipyard_default_actions_url": setting.Actions.DefaultActionsURL.URL(),
	})
	if err != nil {
