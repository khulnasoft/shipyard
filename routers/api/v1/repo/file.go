...
import (
	...
	"github.com/khulnasoft/shipyard/modules/httpcache"
...
const shipyardObjectTypeHeader = "X-Shipyard-Object-Type"
...
func GetRawFile(ctx *context.APIContext) {
	...
	ctx.RespHeader().Set(shipyardObjectTypeHeader, string(files_service.GetObjectTypeFromTreeEntry(entry)))
