...
import (
	...
	"github.com/khulnasoft/shipyard/modules/activitypub"
	shipyard_context "github.com/khulnasoft/shipyard/modules/context"
	"github.com/khulnasoft/shipyard/modules/httplib"
...
func fetch(iri *url.URL) (b []byte, err error) {
	...
	req.Header("User-Agent", "Shipyard/"+setting.AppVer)
...
func verifyHTTPSignatures(ctx *shipyard_context.APIContext) (authenticated bool, err error) {
	r := ctx.Req
...
func ReqHTTPSignature() func(ctx *shipyard_context.APIContext) {
	return func(ctx *shipyard_context.APIContext) {
