...
// NodeInfo returns the NodeInfo for the Shipyard instance to allow for federation
func NodeInfo(ctx *context.APIContext) {
	// swagger:operation GET /nodeinfo miscellaneous getNodeInfo
	// ---
	// summary: Returns the nodeinfo of the Shipyard application
	// produces:
	// - application/json
	// responses:
	//   "200":
	...
	nodeInfo := &structs.NodeInfo{
		...
		Software: structs.NodeInfoSoftware{
			...
			Repository: "https://github.com/go-shipyard/shipyard.git",
