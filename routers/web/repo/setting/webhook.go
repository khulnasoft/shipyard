...
func Webhooks(ctx *context.Context) {
	...
	ctx.Data["Description"] = ctx.Tr("repo.settings.hooks_desc", "https://docs.shipyard.khulnasoft.com/usage/webhooks")
...
// ShipyardHooksNewPost response for creating Shipyard webhook
func ShipyardHooksNewPost(ctx *context.Context) {
	createWebhook(ctx, shipyardHookParams(ctx))
}

// ShipyardHooksEditPost response for editing Shipyard webhook
func ShipyardHooksEditPost(ctx *context.Context) {
	editWebhook(ctx, shipyardHookParams(ctx))
}

func shipyardHookParams(ctx *context.Context) webhookParams {
